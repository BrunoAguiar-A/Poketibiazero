DUELISTS_VOICES = {
    startDuelVoices = {
        ...
        "Este ser� o seu fim!",
        "Voc� n�o tem chance contra mim!",
        "Vamos ver do que voc� � capaz!",
        "Seu destino est� selado!",
        "Vou esmagar voc�!",
        "Nenhum de n�s sair� ileso!",
        "Sua derrota � certa!",
        "Enfrente o seu pior pesadelo!"
    },
    deathDuelVoices = {
        "Voc� me venceu, mas n�o a guerra!",
        "Isso n�o acabou... eu voltarei!",
        "Hoje voc� venceu, mas eu me vingarei!",
        "A vit�ria � sua, por enquanto!",
        "Este � apenas um rev�s tempor�rio!",
        "Voc� pode ter ganho a batalha, mas n�o a guerra!",
        "Minha derrota n�o ser� em v�o!",
        "Lembre-se, um dia eu retornarei mais forte!",
        "Voc� teve sorte desta vez!",
        "Minha queda ser� sua ru�na!"
    },
    fleeingVoices = {
        "Voc� ainda n�o me venceu!",
        "Preciso recuar, mas n�o acabou!",
        "Vou me reagrupando, espere por mim!",
        "Isso n�o est� indo bem, preciso sair daqui!",
        "Retirada estrat�gica!",
        "Voc� teve sorte, mas eu voltarei!",
        "Vou me preparar melhor para nossa pr�xima batalha!",
        "Isso n�o � o fim, apenas um recuo tempor�rio!",
        "Eu voltarei mais forte!",
        "N�o pense que isso acabou!"
    },
}
                ...
                if player:getStorageValue(i) == item:getId() then
                    if not item:moveTo(player) then
                        player:sendTextMessage(MESSAGE_EVENT_ADVANCE,
                            "Voc� n�o tem capacidade, ent�o o loot foi deixado no corpo.")
                        break
                    end
                end
            end
...
function Player.startContract(self, id)
    ...
    if not self:canGetContracts() then
        self:popupFYI("Voc� j� pegou o m�ximo de contratos di�rios.")
        return false
    end
...
function Player.cancelContract(self, id)
    ...
    if not PLAYER_GUID_BH[self:getGuid()] or not PLAYER_GUID_BH_IDS[player:getGuid()] then
        player:popupFYI("Voc� n�o tem contratos ativos.")
        return false
    end
    if not PLAYER_GUID_BH_IDS[player:getGuid()][id] then
        player:popupFYI("Contrato n�o encontrado.")
        return false
    end
