...
function Player:addCatchTry(pokeName, pokeball, points)
    ...
    self:sendTextMessage(MESSAGE_STATUS_CONSOLE_BLUE, string.format("Voc� ganhou %d pontos, total: %d", points, self:getCatchPoints(pokeName)))
end
