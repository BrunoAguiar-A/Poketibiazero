...
local mType = Game.createMonsterType("Shiny Feraligatr")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Shiny Feraligatr"
...
pokemon.moves = {
    ...
    {name = "Ice Fang", power = 5, interval = 28000},
    {name = "Aqua Tail", power = 5, interval = 30000},
    {name = "Hydro Cannon", power = 5, interval = 50000},
    {name = "Waterfall", power = 5, interval = 35000},
    {name = "Water Spout", power = 5, interval = 60000},
...
pokemon.attacks = {
    ...
    {name = "Ice Fang", power = 5, interval = 28000, chance = 100},
    {name = "Aqua Tail", power = 5, interval = 30000, chance = 100},
    {name = "Hydro Cannon", power = 5, interval = 50000, chance = 100},
    {name = "Waterfall", power = 5, interval = 35000, chance = 100},
    {name = "Water Spout", power = 5, interval = 60000, chance = 100},
