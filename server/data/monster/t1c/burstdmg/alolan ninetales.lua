...
local mType = Game.createMonsterType("Alolan Ninetales")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Alolan Ninetales"
...
pokemon.moves = {
    ...
    {name = "Flame Wheel", power = 5, interval = 35000},
    {name = "Fire Ball", power = 5, interval = 20000},
    {name = "Fire Spin", power = 5, interval = 35000},
...
pokemon.attacks = {
    ...
    {name = "Flame Wheel", power = 5, interval = 35000, chance = 100},
    {name = "Fire Ball", power = 5, interval = 20000, chance = 100},
    {name = "Fire Spin", power = 5, interval = 35000, chance = 100},
