...
local mType = Game.createMonsterType("Shiny Tentacruel")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Shiny Tentacruel"
...
pokemon.moves = {
    ...
    {name = "Water Gun", power = 5, interval = 8000},
...
pokemon.attacks = {
    ...
    {name = "Water Gun", power = 5, interval = 8000, chance = 100},
