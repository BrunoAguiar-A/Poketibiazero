...
local mType = Game.createMonsterType("Shelgon")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Dragon Breath", power = 15, interval = 40000},
...
pokemon.attacks = {
    ...
    {name = "Dragon Breath", power = 15, interval = 40000, chance = 100},
