...
local mType = Game.createMonsterType("Shiny Victreebel")
local pokemon = {}
...
pokemon.attacks = {
    ...
    {name = "Giga Drain", power = 5, interval = 50000, chance = 100},
    ...
    {name = "Leaf Tornado", power = 5, interval = 50000, chance = 100},
    {name = "Growth", power = 5, interval = 50000, chance = 100},
}
