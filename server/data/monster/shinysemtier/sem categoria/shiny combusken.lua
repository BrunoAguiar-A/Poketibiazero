...
local mType = Game.createMonsterType("Shiny Combusken")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Sky Uppercut", power = 5, interval = 28000},
...
pokemon.attacks = {
    ...
    {name = "Sky Uppercut", power = 5, interval = 28000, chance = 100},
