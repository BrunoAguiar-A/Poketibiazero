...
local mType = Game.createMonsterType("Shiny Flygon")
local pokemon = {}
...
pokemon.moves = {
    {name = "Supersonic", power = 5, interval = 25000},
    {name = "Sand Attack", power = 5, interval = 10000},
    {name = "Sand Tomb", power = 5, interval = 40000},
    {name = "Dragon Flight", power = 5, interval = 20000},
    {name = "Bulldoze", power = 5, interval = 25000},
    {name = "Fissure", power = 5, interval = 45000},
    {name = "Hyper Beam", power = 5, interval = 60000},
    {name = "Earthquake", power = 5, interval = 60000},
    {name = "Sandstorm", power = 5, interval = 60000},
    {name = "Screech", power = 5, interval = 60000},
...
pokemon.attacks = {
    {name = "Supersonic", power = 5, interval = 25000, chance = 100},
    {name = "Sand Attack", power = 5, interval = 10000, chance = 100},
    {name = "Sand Tomb", power = 5, interval = 40000, chance = 100},
    {name = "Dragon Flight", power = 5, interval = 20000, chance = 100},
    {name = "Bulldoze", power = 5, interval = 25000, chance = 100},
    {name = "Fissure", power = 5, interval = 45000, chance = 100},
    {name = "Hyper Beam", power = 5, interval = 60000, chance = 100},
    {name = "Earthquake", power = 5, interval = 60000, chance = 100},
    {name = "Sandstorm", power = 5, interval = 60000, chance = 100},
    {name = "Screech", power = 5, interval = 60000, chance = 100},
