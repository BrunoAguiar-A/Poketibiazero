...
local mType = Game.createMonsterType("Shiny Sneasel")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Metal Claw", power = 5, interval = 30000},
    {name = "Shadow Claw", power = 5, interval = 35000},
...
pokemon.attacks = {
    ...
    {name = "Metal Claw", power = 5, interval = 30000, chance = 100},
    {name = "Shadow Claw", power = 5, interval = 35000, chance = 100},
