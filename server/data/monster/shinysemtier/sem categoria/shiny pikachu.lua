...
local mType = Game.createMonsterType("Pikachu")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Shock Wave", power = 5, interval = 30000},
    {name = "Thunder Punch", power = 5, interval = 30000},
    {name = "Thunder", power = 5, interval = 60000},
    {name = "Electric Storm", power = 5, interval = 80000},
...
pokemon.attacks = {
    ...
    {name = "Shock Wave", power = 5, interval = 30000, chance = 100},
    {name = "Thunder Punch", power = 5, interval = 30000, chance = 100},
    {name = "Thunder", power = 5, interval = 60000, chance = 100},
    {name = "Electric Storm", power = 5, interval = 80000, chance = 100},
