...
local mType = Game.createMonsterType("Shiny Rattata")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Shiny Rattata"
...
pokemon.moves = {
    ...
    {name = "Super Fang", power = 5, interval = 20000},
...
pokemon.attacks = {
    ...
    {name = "Super Fang", power = 5, interval = 20000, chance = 100},
