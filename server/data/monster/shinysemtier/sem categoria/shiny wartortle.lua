...
local mType = Game.createMonsterType("Shiny Wartortle")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Skull Bash", power = 5, interval = 35000},
...
pokemon.attacks = {
    ...
    {name = "Skull Bash", power = 5, interval = 35000, chance = 100},
