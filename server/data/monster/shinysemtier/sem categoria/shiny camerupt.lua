...
local mType = Game.createMonsterType("Shiny Camerupt")
local pokemon = {}
...
pokemon.moves = {
    {name = "Volcano Shot", power = 5, interval = 15000},
    {name = "Ember", power = 5, interval = 10000},
    {name = "Mud Bomb", power = 5, interval = 20000},
    {name = "Flame Burst", power = 5, interval = 20000},
...
pokemon.attacks = {
    {name = "Volcano Shot", power = 5, interval = 15000, chance = 100},
    {name = "Ember", power = 5, interval = 10000, chance = 100},
    {name = "Mud Bomb", power = 5, interval = 20000, chance = 100},
    {name = "Flame Burst", power = 5, interval = 20000, chance = 100},
