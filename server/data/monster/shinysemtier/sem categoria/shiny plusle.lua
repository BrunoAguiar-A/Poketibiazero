...
local mType = Game.createMonsterType("Shiny Plusle")
local pokemon = {}
...
pokemon.moves = {
    {name = "Sweet Kiss", power = 5, interval = 25000},
...
pokemon.attacks = {
    {name = "Sweet Kiss", power = 5, interval = 25000, chance = 100},
