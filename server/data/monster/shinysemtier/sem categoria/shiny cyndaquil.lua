...
local mType = Game.createMonsterType("Shiny Cyndaquil")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Shiny Cyndaquil"
...
pokemon.attacks = {
    ...
    {name = "Swift", power = 5, interval = 12000, chance = 100},
    ...
    {name = "Smokescreen", power = 5, interval = 28000, chance = 100},
    {name = "Overheat", power = 5, interval = 60000, chance = 100},
    {name = "Defense Curl", power = 5, interval = 30000, chance = 100},
}
