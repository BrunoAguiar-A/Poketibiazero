...
local mType = Game.createMonsterType("Shiny Omastar")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Rollout", power = 5, interval = 35000},
    ...
    {name = "Rain Dance", power = 5, interval = 60000},
...
pokemon.attacks = {
    ...
    {name = "Rollout", power = 5, interval = 35000, chance = 100},
    ...
    {name = "Rain Dance", power = 5, interval = 60000, chance = 100},
