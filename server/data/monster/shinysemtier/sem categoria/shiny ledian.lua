...
local mType = Game.createMonsterType("Ledian")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Ledian"
...
pokemon.moves = {
    ...
    {name = "Silver Wind", power = 5, interval = 12000},
    {name = "Struggle Bug", power = 5, interval = 30000},
    {name = "Bug Buzz", power = 5, interval = 25000},
...
pokemon.attacks = {
    ...
    {name = "Silver Wind", power = 5, interval = 12000, chance = 100},
    {name = "Struggle Bug", power = 5, interval = 30000, chance = 100},
    {name = "Bug Buzz", power = 5, interval = 25000, chance = 100},
