...
local mType = Game.createMonsterType("Shiny Grimer")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Shiny Grimer"
...
pokemon.moves = {
    ...
    {name = "Poison Bomb", power = 5, interval = 28000},
    {name = "Venoshock", power = 5, interval = 80000},
    {name = "Sludge Wave", power = 5, interval = 60000},
...
pokemon.attacks = {
    ...
    {name = "Poison Bomb", power = 5, interval = 28000, chance = 100},
    {name = "Venoshock", power = 5, interval = 80000, chance = 100},
    {name = "Sludge Wave", power = 5, interval = 60000, chance = 100},
