...
local mType = Game.createMonsterType("Shiny Quilava")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Smokescreen", power = 5, interval = 20000},
...
pokemon.attacks = {
    ...
    {name = "Smokescreen", power = 5, interval = 20000, chance = 100},
