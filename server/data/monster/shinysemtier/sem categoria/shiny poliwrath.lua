...
pokemon.moves = {
    ...
    {name = "Doubleslap", power = 5, interval = 10000},
    {name = "Bubble Beam", power = 5, interval = 20000},
    {name = "Water Gun", power = 5, interval = 15000},
    {name = "Liquidation", power = 5, interval = 30000},
    {name = "Surf", power = 5, interval = 60000},
    {name = "Dynamic Punch", power = 5, interval = 30000},
...
pokemon.attacks = {
    ...
    {name = "Doubleslap", power = 5, interval = 10000, chance = 100},
    {name = "Bubble Beam", power = 5, interval = 20000, chance = 100},
    {name = "Water Gun", power = 5, interval = 15000, chance = 100},
    {name = "Liquidation", power = 5, interval = 30000, chance = 100},
    {name = "Surf", power = 5, interval = 60000, chance = 100},
    {name = "Dynamic Punch", power = 5, interval = 30000, chance = 100},
