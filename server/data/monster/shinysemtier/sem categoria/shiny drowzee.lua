...
local mType = Game.createMonsterType("Shiny Drowzee")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Dream Eater", power = 5, interval = 45000},
...
pokemon.attacks = {
    ...
    {name = "Dream Eater", power = 5, interval = 45000, chance = 100},
