...
local mType = Game.createMonsterType("Shiny Diglett")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Shiny Diglett"
...
pokemon.moves = {
    ...
    {name = "Slash", power = 5, interval = 5000},
...
pokemon.attacks = {
    ...
    {name = "Slash", power = 5, interval = 5000, chance = 100},
