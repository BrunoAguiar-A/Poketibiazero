...
local mType = Game.createMonsterType("Shiny Wynaut")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Wynaut"
...
pokemon.moves = {
    {name = "Safeguard", power = 5, interval = 60000},
...
pokemon.attacks = {
    {name = "Safeguard", power = 5, interval = 60000, chance = 100},
