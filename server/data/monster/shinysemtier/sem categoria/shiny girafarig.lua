...
local mType = Game.createMonsterType("Shiny Girafarig")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Shock Wave", power = 5, interval = 25000},
    {name = "Astonish", power = 5, interval = 25000},
    {name = "Assurance", power = 5, interval = 50000},
    {name = "Nasty Plot", power = 5, interval = 25000},
    {name = "Reflect", power = 5, interval = 60000},
...
pokemon.attacks = {
    ...
    {name = "Shock Wave", power = 5, interval = 25000, chance = 100},
    {name = "Astonish", power = 5, interval = 25000, chance = 100},
    {name = "Assurance", power = 5, interval = 50000, chance = 100},
    {name = "Nasty Plot", power = 5, interval = 25000, chance = 100},
    {name = "Reflect", power = 5, interval = 60000, chance = 100},
