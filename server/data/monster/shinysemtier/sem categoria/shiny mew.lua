...
local mType = Game.createMonsterType("Shiny Mew")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Brine", power = 5, interval = 5000},
    {name = "Flamethrower", power = 5, interval = 5000},
    {name = "Thunderbolt", power = 5, interval = 5000},
    {name = "Psychic", power = 5, interval = 20000},
    {name = "Instant Teleportation", power = 5, interval = 10000},
    {name = "Hydro Cannon", power = 5, interval = 35000},
    {name = "Solar Beam", power = 5, interval = 35000},
    {name = "Ancient Power", power = 5, interval = 35000},
    {name = "Metronome", power = 5, interval = 35000},
...
pokemon.attacks = {
    ...
    {name = "Brine", power = 5, interval = 5000, chance = 100},
    {name = "Flamethrower", power = 5, interval = 5000, chance = 100},
    {name = "Thunderbolt", power = 5, interval = 5000, chance = 100},
    {name = "Psychic", power = 5, interval = 20000, chance = 100},
    {name = "Instant Teleportation", power = 5, interval = 10000, chance = 100},
    {name = "Hydro Cannon", power = 5, interval = 35000, chance = 100},
    {name = "Solar Beam", power = 5, interval = 35000, chance = 100},
    {name = "Ancient Power", power = 5, interval = 35000, chance = 100},
    {name = "Metronome", power = 5, interval = 35000, chance = 100},
