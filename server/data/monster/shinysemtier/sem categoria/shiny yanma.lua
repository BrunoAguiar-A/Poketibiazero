...
local mType = Game.createMonsterType("Shiny Yanma")
local pokemon = {}
...
pokemon.attacks = {
    ...
    {name = "U-Turn", power = 5, interval = 15000, chance = 100},
    ...
    {name = "Bug Buzz", power = 5, interval = 50000, chance = 100},
}
