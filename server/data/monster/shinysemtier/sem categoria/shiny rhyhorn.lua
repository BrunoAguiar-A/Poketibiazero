...
local mType = Game.createMonsterType("Shiny Rhyhorn")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Drill Run", power = 5, interval = 35000},
}
...
pokemon.attacks = {
    ...
    {name = "Drill Run", power = 5, interval = 35000, chance = 100},
}
