...
local mType = Game.createMonsterType("Shiny Anorith")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Anorith"
...
pokemon.moves = {
    ...
    {name = "Hunter Mark", power = 5, interval = 40000},
...
pokemon.attacks = {
    ...
    {name = "Hunter Mark", power = 5, interval = 40000, chance = 100},
