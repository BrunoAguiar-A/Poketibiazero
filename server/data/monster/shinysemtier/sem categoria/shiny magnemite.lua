...
local mType = Game.createMonsterType("Shiny Magnemite")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Spark", power = 5, interval = 20000},
    {name = "Electro Ball", power = 5, interval = 45000},
    {name = "Sonicboom", power = 5, interval = 30000},
}
...
pokemon.attacks = {
    ...
    {name = "Spark", power = 5, interval = 20000, chance = 100},
    {name = "Electro Ball", power = 5, interval = 45000, chance = 100},
    {name = "Sonicboom", power = 5, interval = 30000, chance = 100},
}
