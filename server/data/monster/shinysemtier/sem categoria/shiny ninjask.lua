...
local mType = Game.createMonsterType("Shiny Ninjask")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Silver Wind", power = 5, interval = 18000},
    {name = "Fury Swipes", power = 5, interval = 20000},
    {name = "X-Scissor", power = 5, interval = 20000},
    {name = "Swords Dance", power = 5, interval = 60000},
    {name = "Substitute", power = 5, interval = 50000},
...
pokemon.attacks = {
    ...
    {name = "Silver Wind", power = 5, interval = 18000, chance = 100},
    {name = "Fury Swipes", power = 5, interval = 20000, chance = 100},
    {name = "X-Scissor", power = 5, interval = 20000, chance = 100},
    {name = "Swords Dance", power = 5, interval = 60000, chance = 100},
    {name = "Substitute", power = 5, interval = 50000, chance = 100},
