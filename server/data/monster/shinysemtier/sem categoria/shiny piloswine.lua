...
local mType = Game.createMonsterType("Shiny Piloswine")
local pokemon = {}
...
pokemon.moves = {
    {name = "Mud Sport", power = 5, interval = 22000},
    {name = "Ice Fang", power = 5, interval = 10000},
    {name = "Ice Wind", power = 5, interval = 15000},
    {name = "Powder Snow", power = 5, interval = 40000},
    {name = "Frost Breath", power = 12, interval = 20000},
    {name = "Stomping Tantrum", power = 5, interval = 20000},
    {name = "Bulldoze", power = 5, interval = 35000},
...
pokemon.attacks = {
    {name = "Mud Sport", power = 5, interval = 22000, chance = 100},
    {name = "Ice Fang", power = 5, interval = 10000, chance = 100},
    {name = "Ice Wind", power = 5, interval = 15000, chance = 100},
    {name = "Powder Snow", power = 5, interval = 40000, chance = 100},
    {name = "Frost Breath", power = 12, interval = 20000, chance = 100},
    {name = "Stomping Tantrum", power = 5, interval = 20000, chance = 100},
    {name = "Bulldoze", power = 5, interval = 35000, chance = 100},
