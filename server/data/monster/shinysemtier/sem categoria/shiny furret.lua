...
local mType = Game.createMonsterType("Shiny Furret")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Furret"
...
pokemon.moves = {
    ...
    {name = "Hyper Voice", power = 5, interval = 25000},
    {name = "Sucker Punch", power = 5, interval = 45000},
    {name = "Rest", power = 5, interval = 50000},
}
...
pokemon.attacks = {
    ...
    {name = "Hyper Voice", power = 5, interval = 25000, chance = 100},
    {name = "Sucker Punch", power = 5, interval = 45000, chance = 100},
    {name = "Rest", power = 5, interval = 50000, chance = 100},
}
