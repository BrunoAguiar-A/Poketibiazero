...
local mType = Game.createMonsterType("Shiny Slowbro")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Slowbro"
...
pokemon.moves = {
    ...
    {name = "Water Ball", power = 5, interval = 20000},
    {name = "Water Gun", power = 5, interval = 20000},
    {name = "Confusion", power = 5, interval = 20000},
    {name = "Psychic", power = 5, interval = 30000},
    {name = "Yawn", power = 5, interval = 30000},
}
...
pokemon.attacks = {
    ...
    {name = "Water Ball", power = 5, interval = 20000, chance = 100},
    {name = "Water Gun", power = 5, interval = 20000, chance = 100},
    {name = "Confusion", power = 5, interval = 20000, chance = 100},
    {name = "Psychic", power = 5, interval = 30000, chance = 100},
    {name = "Yawn", power = 5, interval = 30000, chance = 100},
}
