...
local mType = Game.createMonsterType("Shiny Sunflora")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Bullet Seed", power = 5, interval = 30000},
...
pokemon.attacks = {
    ...
    {name = "Bullet Seed", power = 5, interval = 30000, chance = 100},
