...
local mType = Game.createMonsterType("Shiny Sandshrew")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Shiny Sandshrew"
...
pokemon.moves = {
    ...
    {name = "Scratch", power = 5, interval = 5000},
...
pokemon.attacks = {
    ...
    {name = "Scratch", power = 5, interval = 5000, chance = 100},
