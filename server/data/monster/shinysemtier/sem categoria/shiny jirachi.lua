...
pokemon.moves = {
    ...
    {name = "Zen Headbutt", power = 5, interval = 60000},
    {name = "Future Sight", power = 5, interval = 35000},
    {name = "Cosmic Power", power = 5, interval = 40000},
    {name = "Last Resort", power = 5, interval = 15000},
    {name = "Meteor Mash", power = 5, interval = 35000},
    {name = "Doom Desire", power = 5, interval = 25000},
...
pokemon.attacks = {
    ...
    {name = "Zen Headbutt", power = 5, interval = 60000, chance = 100},
    {name = "Future Sight", power = 5, interval = 35000, chance = 100},
    {name = "Cosmic Power", power = 5, interval = 40000, chance = 100},
    {name = "Last Resort", power = 5, interval = 15000, chance = 100},
    {name = "Meteor Mash", power = 5, interval = 35000, chance = 100},
    {name = "Doom Desire", power = 5, interval = 25000, chance = 100},
