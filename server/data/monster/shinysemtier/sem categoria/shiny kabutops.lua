...
local mType = Game.createMonsterType("Shiny Kabutops")
local pokemon = {}
...
pokemon.moves = {
    {name = "Ancient Absorb", power = 5, interval = 10000},
    {name = "Leech Life", power = 5, interval = 20000},
    ...
    {name = "Liquidation", power = 5, interval = 25000},
...
pokemon.attacks = {
    {name = "Ancient Absorb", power = 5, interval = 10000, chance = 100},
    {name = "Leech Life", power = 5, interval = 20000, chance = 100},
    ...
    {name = "Liquidation", power = 5, interval = 25000, chance = 100},
