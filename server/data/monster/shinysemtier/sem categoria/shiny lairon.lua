...
local mType = Game.createMonsterType("Shiny Lairon")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Meteor Mash", power = 5, interval = 30000},
...
pokemon.attacks = {
    ...
    {name = "Meteor Mash", power = 5, interval = 30000, chance = 100},
