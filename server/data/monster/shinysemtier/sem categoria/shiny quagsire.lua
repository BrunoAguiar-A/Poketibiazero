...
local mType = Game.createMonsterType("Shiny Quagsire")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Quagsire"
...
pokemon.moves = {
    {name = "Slam", power = 5, interval = 15000},
    ...
    {name = "Sand Tomb", power = 5, interval = 35000},
    {name = "Muddy Water", power = 5, interval = 35000},
    {name = "Earthquake", power = 5, interval = 80000},
}



pokemon.attacks = {
    {name = "Slam", power = 5, interval = 15000, chance = 100},
    ...
    {name = "Sand Tomb", power = 5, interval = 35000, chance = 100},
    {name = "Muddy Water", power = 5, interval = 35000, chance = 100},
    {name = "Earthquake", power = 5, interval = 80000, chance = 100},
}
