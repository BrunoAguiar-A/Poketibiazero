...
local mType = Game.createMonsterType("Shiny Kecleon")
local pokemon = {}
...
pokemon.moves = {
    {name = "Lick", power = 5, interval = 25000},
    {name = "Shadow Ball", power = 5, interval = 10000},
    {name = "Foul Play", power = 5, interval = 15000},
    {name = "Sucker Punch", power = 5, interval = 30000},
    {name = "Camouflage", power = 5, interval = 15000},
...
pokemon.attacks = {
    {name = "Lick", power = 5, interval = 25000, chance = 100},
    {name = "Shadow Ball", power = 5, interval = 10000, chance = 100},
    {name = "Foul Play", power = 5, interval = 15000, chance = 100},
    {name = "Sucker Punch", power = 5, interval = 30000, chance = 100},
    {name = "Camouflage", power = 5, interval = 15000, chance = 100},
