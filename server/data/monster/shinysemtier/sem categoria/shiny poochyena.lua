...
local mType = Game.createMonsterType("Shiny Poochyena")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Shadow Claw", power = 5, interval = 45000},
...
pokemon.attacks = {
    ...
    {name = "Shadow Claw", power = 5, interval = 45000, chance = 100},
