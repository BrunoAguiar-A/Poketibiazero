...
pokemon.moves = {
    ...
    {name = "Swift", power = 5, interval = 13000},
    {name = "Shadow Ball", power = 5, interval = 5000},
    {name = "Psy Ball", power = 5, interval = 12000},
...
pokemon.attacks = {
    ...
    {name = "Swift", power = 5, interval = 13000, chance = 100},
    {name = "Shadow Ball", power = 5, interval = 5000, chance = 100},
    {name = "Psy Ball", power = 5, interval = 12000, chance = 100},
