...
local mType = Game.createMonsterType("Shiny Haunter")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Shiny Haunter"
...
pokemon.moves = {
    {name = "Lick", power = 5, interval = 35000},
    {name = "Shadow Ball", power = 5, interval = 8000},
    {name = "Night Shade", power = 5, interval = 30000},
    {name = "Shadow Storm", power = 5, interval = 60000},
    {name = "Invisible", power = 5, interval = 18000},
    {name = "Nightmare", power = 5, interval = 50000},
    {name = "Hypnosis", power = 5, interval = 50000},
    {name = "Fear", power = 5, interval = 40000},
    {name = "Dark Accurate", power = 5, interval = 20000},
}



pokemon.attacks = {
    {name = "Lick", power = 5, interval = 35000, chance = 100},
    ...
    {name = "Invisible", power = 5, interval = 18000, chance = 100},
    {name = "Nightmare", power = 5, interval = 50000, chance = 100},
    {name = "Hypnosis", power = 5, interval = 50000, chance = 100},
    {name = "Fear", power = 5, interval = 40000, chance = 100},
    {name = "Dark Accurate", power = 5, interval = 20000, chance = 100},
}
