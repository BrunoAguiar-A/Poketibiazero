...
local mType = Game.createMonsterType("Shiny Smoochum")
local pokemon = {}
...
pokemon.moves = {
    {name = "Lovely Kiss", power = 5, interval = 25000},
    {name = "Draining Kiss", power = 5, interval = 40000},
    {name = "Psywave", power = 5, interval = 15000},
    {name = "Psy Pulse", power = 5, interval = 20000},
    {name = "Ice Ball", power = 5, interval = 35000},
...
pokemon.attacks = {
    {name = "Lovely Kiss", power = 5, interval = 25000, chance = 100},
    {name = "Draining Kiss", power = 5, interval = 40000, chance = 100},
    {name = "Psywave", power = 5, interval = 15000, chance = 100},
    {name = "Psy Pulse", power = 5, interval = 20000, chance = 100},
    {name = "Ice Ball", power = 5, interval = 35000, chance = 100},
