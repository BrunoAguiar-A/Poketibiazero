...
local mType = Game.createMonsterType("Shiny Sunkern")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Leech Seed", power = 5, interval = 35000},
...
pokemon.attacks = {
    ...
    {name = "Leech Seed", power = 5, interval = 35000, chance = 100},
