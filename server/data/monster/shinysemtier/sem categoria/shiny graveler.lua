...
local mType = Game.createMonsterType("Shiny Graveler")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Shiny Graveler"
...
pokemon.moves = {
    ...
    {name = "Falling Rocks", power = 5, interval = 80000},
...
pokemon.attacks = {
    ...
    {name = "Falling Rocks", power = 5, interval = 80000, chance = 100},
