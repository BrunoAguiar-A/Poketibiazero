...
local mType = Game.createMonsterType("Shiny Spinarak")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Poison Sting", power = 5, interval = 8000},
    {name = "Fury Swipes", power = 5, interval = 20000},
    {name = "Poison Jab", power = 5, interval = 15000},
}
...
pokemon.attacks = {
    ...
    {name = "Poison Sting", power = 5, interval = 8000, chance = 100},
    {name = "Fury Swipes", power = 5, interval = 20000, chance = 100},
    {name = "Poison Jab", power = 5, interval = 15000, chance = 100},
}
