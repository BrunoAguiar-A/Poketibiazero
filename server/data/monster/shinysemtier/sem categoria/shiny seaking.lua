...
local mType = Game.createMonsterType("Shiny Seaking")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Seaking"
...
pokemon.moves = {
    ...
    {name = "Horn Drill", power = 5, interval = 40000},
...
pokemon.attacks = {
    ...
    {name = "Horn Drill", power = 5, interval = 40000, chance = 100},
