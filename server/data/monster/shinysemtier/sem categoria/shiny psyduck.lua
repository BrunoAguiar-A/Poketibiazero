...
local mType = Game.createMonsterType("Shiny Psyduck")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Shiny Psyduck"
...
pokemon.moves = {
    ...
    {name = "Psy ball", power = 5, interval = 15000},
    {name = "Bubble Beam", power = 5, interval = 18000},
...
pokemon.attacks = {
    ...
    {name = "Psy ball", power = 5, interval = 15000, chance = 100},
    {name = "Bubble Beam", power = 5, interval = 18000, chance = 100},
