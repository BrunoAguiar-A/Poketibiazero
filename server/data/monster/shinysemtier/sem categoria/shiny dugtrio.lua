...
local mType = Game.createMonsterType("Shiny Dugtrio")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Shiny Dugtrio"
...
pokemon.moves = {
    {name = "Sand Attack", power = 5, interval = 20000},
...
pokemon.attacks = {
    {name = "Sand Attack", power = 5, interval = 20000, chance = 100},
