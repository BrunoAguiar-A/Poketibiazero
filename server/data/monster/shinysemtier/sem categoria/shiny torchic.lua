...
local mType = Game.createMonsterType("Shiny Torchic")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Shiny Torchic"
...
pokemon.attacks = {
    ...
    {name = "Drill Peck", power = 9, interval = 12000, chance = 100},
    ...
    {name = "Fire Spin", power = 5, interval = 30000, chance = 100},
