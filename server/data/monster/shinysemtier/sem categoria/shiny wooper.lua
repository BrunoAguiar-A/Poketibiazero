...
local mType = Game.createMonsterType("Shiny Wooper")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Muddy Water", power = 5, interval = 60000},
...
pokemon.attacks = {
    ...
    {name = "Muddy Water", power = 5, interval = 60000, chance = 100},
