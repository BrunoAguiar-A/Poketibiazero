...
pokemon.moves = {
    ...
    {name = "Rock Throw", power = 1, interval = 10000},
    {name = "Rock Slide", power = 1, interval = 15000},
    {name = "Rock Tomb", power = 1, interval = 15000},
    {name = "Stone Edge", power = 1, interval = 20000},
    {name = "Hammer Arm", power = 1, interval = 25000},
    {name = "Ancient Power", power = 1, interval = 50000},
    {name = "Rock Wrecker", power = 1, interval = 50000},
...
pokemon.attacks = {
    ...
    {name = "Rock Throw", power = 1, interval = 10000, chance = 100},
    {name = "Rock Slide", power = 1, interval = 15000, chance = 100},
    {name = "Rock Tomb", power = 1, interval = 15000, chance = 100},
    {name = "Stone Edge", power = 1, interval = 20000, chance = 100},
    {name = "Hammer Arm", power = 1, interval = 25000, chance = 100},
    {name = "Ancient Power", power = 1, interval = 50000, chance = 100},
    {name = "Rock Wrecker", power = 1, interval = 50000, chance = 100},
