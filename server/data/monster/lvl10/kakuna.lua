...
local mType = Game.createMonsterType("Kakuna")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Kakuna"
...
pokemon.evolutions = {
    {
        ...
        chance = 100,
        stones = {
            {stoneId = 26724, stoneCount = 1} --water = 26732, fire = 26728, leaf = 26731, cocoon = 26724
        }
    }
}
...
pokemon.moves = {
    ...
    {name = "Harden", power = 0, interval = 20000},
...
pokemon.attacks = {
    ...
    {name = "Harden", power = 0, interval = 20000, chance = 100},
