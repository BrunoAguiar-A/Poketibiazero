...
local mType = Game.createMonsterType("Ledyba")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Silver Wind", power = 15, interval = 20000},
...
pokemon.attacks = {
    ...
    {name = "Silver Wind", power = 15, interval = 20000, chance = 100},
