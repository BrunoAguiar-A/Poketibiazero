...
local mType = Game.createMonsterType("Unown")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Hidden Power", power = 7, interval = 20000},
}
...
pokemon.attacks = {
    ...
    {name = "Hidden Power", power = 7, interval = 20000, chance = 100},
}
