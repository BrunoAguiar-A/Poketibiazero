...
local mType = Game.createMonsterType("Ekans")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Ekans"
...
pokemon.moves = {
    ...
    {name = "Poison Fang", power = 7, interval = 10000},
...
pokemon.attacks = {
    ...
    {name = "Poison Fang", power = 7, interval = 10000, chance = 100},
