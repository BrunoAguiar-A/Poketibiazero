...
local mType = Game.createMonsterType("War Pinsir")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a War Pinsir"
...
pokemon.moves = {
    ...
    {name = "Guillotine", power = 7, interval = 35000},
    {name = "Bind", power = 7, interval = 35000},
...
pokemon.attacks = {
    ...
    {name = "Guillotine", power = 7, interval = 35000, chance = 100},
    {name = "Bind", power = 7, interval = 35000, chance = 100},
