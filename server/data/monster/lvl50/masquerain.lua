...
local mType = Game.createMonsterType("Masquerain")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Infestation", power = 7, interval = 40000},
...
pokemon.attacks = {
    ...
    {name = "Infestation", power = 7, interval = 40000, chance = 100},
