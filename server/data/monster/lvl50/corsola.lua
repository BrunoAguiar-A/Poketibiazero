...
local mType = Game.createMonsterType("Corsola")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Corsola"
...
pokemon.moves = {
    ...
    {name = "Rock Blast", power = 15, interval = 25000},
    {name = "Power Gem", power = 15, interval = 30000},
...
pokemon.attacks = {
    ...
    {name = "Rock Blast", power = 15, interval = 25000, chance = 100},
    {name = "Power Gem", power = 15, interval = 30000, chance = 100},
