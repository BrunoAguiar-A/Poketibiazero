...
local mType = Game.createMonsterType("Dustox")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Light Screen", power = 0, interval = 80000},
...
pokemon.attacks = {
    ...
    {name = "Light Screen", power = 0, interval = 80000, chance = 100},
