...
local mType = Game.createMonsterType("Roselia")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Razor Leaf", power = 7, interval = 12000},
    {name = "Magical Leaf", power = 12, interval = 15000},
    {name = "Poison Jab", power = 7, interval = 20000},
    {name = "Synthesis", power = 7, interval = 80000},
    {name = "Leaf Tornado", power = 15, interval = 40000},
    {name = "Petal Blizzard", power = 20, interval = 50000},
...
pokemon.attacks = {
    ...
    {name = "Razor Leaf", power = 7, interval = 12000, chance = 100},
    ...
    {name = "Leaf Tornado", power = 15, interval = 40000, chance = 100},
    {name = "Petal Blizzard", power = 20, interval = 50000, chance = 100},
