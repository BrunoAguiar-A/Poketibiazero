...
local mType = Game.createMonsterType("Slowbro")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Water Ball", power = 8, interval = 20000},
    {name = "Water Gun", power = 8, interval = 20000},
    {name = "Confusion", power = 10, interval = 20000},
...
pokemon.attacks = {
    ...
    {name = "Water Ball", power = 8, interval = 20000, chance = 100},
    {name = "Water Gun", power = 8, interval = 20000, chance = 100},
    {name = "Confusion", power = 10, interval = 20000, chance = 100},
