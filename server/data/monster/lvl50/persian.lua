...
local mType = Game.createMonsterType("Persian")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Persian"
...
pokemon.moves = {
    ...
    {name = "Slash", power = 9, interval = 8000},
    {name = "Scratch", power = 7, interval = 8000},
    {name = "Bite", power = 9, interval = 12000},
    {name = "Night Slash", power = 15, interval = 15000},
    {name = "Pay Day", power = 7, interval = 30000},
    {name = "Fear", power = 7, interval = 30000},
...
pokemon.attacks = {
    ...
    {name = "Slash", power = 9, interval = 8000, chance = 100},
    {name = "Scratch", power = 7, interval = 8000, chance = 100},
    {name = "Bite", power = 9, interval = 12000, chance = 100},
    {name = "Night Slash", power = 15, interval = 15000, chance = 100},
    {name = "Pay Day", power = 7, interval = 30000, chance = 100},
    {name = "Fear", power = 7, interval = 30000, chance = 100},
