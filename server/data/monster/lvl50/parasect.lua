...
local mType = Game.createMonsterType("Parasect")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Parasect"
...
pokemon.attacks = {
    ...
    {name = "Poison Bomb", power = 7, interval = 30000, chance = 100},
    ...
    {name = "Fury Cutter", power = 7, interval = 30000, chance = 100},
    {name = "X-Scissor", power = 15, interval = 22000, chance = 100},
}
