...
local mType = Game.createMonsterType("Qwilfish")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Qwilfish"
...
pokemon.moves = {
    ...
    {name = "Toxic Spikes", power = 7, interval = 12000},
    {name = "Poison Tail", power = 7, interval = 20000},
    {name = "Toxic", power = 15, interval = 30000},
    {name = "Minimize", power = 7, interval = 30000},
    {name = "Spike Skin", power = 7, interval = 60000},
}
...
pokemon.attacks = {
    ...
    {name = "Toxic Spikes", power = 7, interval = 12000, chance = 100},
    {name = "Poison Tail", power = 7, interval = 20000, chance = 100},
    {name = "Toxic", power = 15, interval = 30000, chance = 100},
    {name = "Minimize", power = 7, interval = 30000, chance = 100},
    {name = "Spike Skin", power = 7, interval = 60000, chance = 100},
}
