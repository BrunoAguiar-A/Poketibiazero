...
local mType = Game.createMonsterType("Vibrava")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Rock Slide", power = 15, interval = 10000},
    {name = "Sand Tomb", power = 7, interval = 25000},
    {name = "Bulldoze", power = 25, interval = 30000},
...
pokemon.attacks = {
    ...
    {name = "Rock Slide", power = 15, interval = 10000, chance = 100},
    {name = "Sand Tomb", power = 7, interval = 25000, chance = 100},
    {name = "Bulldoze", power = 25, interval = 30000, chance = 100},
