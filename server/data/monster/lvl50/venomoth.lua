...
local mType = Game.createMonsterType("Venomoth")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Venomoth"
...
pokemon.moves = {
    ...
    {name = "Bug Buzz", power = 7, interval = 30000},
...
pokemon.attacks = {
    ...
    {name = "Bug Buzz", power = 7, interval = 30000, chance = 100},
