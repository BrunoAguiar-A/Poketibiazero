...
local mType = Game.createMonsterType("Erika's Victreebel")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Erika's Victreebel"
pokemon.experience = 0
pokemon.outfit = {
    lookType = 71
}

pokemon.health = 27000
...
pokemon.attacks = {
    ...
    {name = "Razor Leaf", power = 23, interval = 1000, chance = 100},
    {name = "Vine Whip", power = 21, interval = 1500, chance = 100},
    {name = "Magical Leaf", power = 14, interval = 2000, chance = 100},
    {name = "Giga Drain", power = 16, interval = 5000, chance = 100},
    {name = "Poison Powder", power = 17, interval = 2000, chance = 100},
    {name = "Sleep Powder", power = 18, interval = 5000, chance = 100},
    {name = "Leaf Storm", power = 20, interval = 5000, chance = 100},
    {name = "Leaf Tornado", power = 25, interval = 5000, chance = 100},
    {name = "Growth", power = 19, interval = 5000, chance = 100},
}
