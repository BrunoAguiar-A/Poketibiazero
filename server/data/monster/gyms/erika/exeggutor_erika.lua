...
local mType = Game.createMonsterType("Erika's Exeggutor")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Erika's Exeggutor"
pokemon.experience = 0
pokemon.outfit = {
    lookType = 103
}

pokemon.health = 26000
...
pokemon.attacks = {
    ...
    {name = "Seed Bomb", power = 15, interval = 2500, chance = 100},
    {name = "Egg Bomb", power = 16, interval = 8000, chance = 100},
    {name = "Leaf Blade", power = 14, interval = 1000, chance = 100},
    {name = "Confusion", power = 15, interval = 2000, chance = 100},
    {name = "Psyshock", power = 14, interval = 3000, chance = 100},
    {name = "Wood Hammer", power = 16, interval = 3000, chance = 100},
    {name = "Solar Beam", power = 17, interval = 4000, chance = 100},
    {name = "Leaf Storm", power = 14, interval = 7000, chance = 100},
    {name = "Hypnosis", power = 12, interval = 5000, chance = 100},
}
