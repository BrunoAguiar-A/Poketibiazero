...
pokemon.moves = {
    ...
    {name = "Meteor Beam", power = 7, interval = 50000},
    {name = "Swift", power = 7, interval = 5000},
    {name = "Confusion", power = 10, interval = 30000},
    {name = "Psychic", power = 12, interval = 30000},
    {name = "Zen Headbutt", power = 15, interval = 60000},
    {name = "Future Sight", power = 7, interval = 35000},
    {name = "Cosmic Power", power = 7, interval = 40000},
    {name = "Last Resort", power = 20, interval = 15000},
    {name = "Meteor Mash", power = 12, interval = 35000},
    {name = "Doom Desire", power = 7, interval = 25000},
...
pokemon.attacks = {
    ...
    {name = "Meteor Beam", power = 7, interval = 50000, chance = 100},
    ...
    {name = "Zen Headbutt", power = 15, interval = 60000, chance = 100},
    {name = "Future Sight", power = 7, interval = 35000, chance = 100},
    {name = "Cosmic Power", power = 7, interval = 40000, chance = 100},
    {name = "Last Resort", power = 20, interval = 15000, chance = 100},
    {name = "Meteor Mash", power = 12, interval = 35000, chance = 100},
    {name = "Doom Desire", power = 7, interval = 25000, chance = 100},
