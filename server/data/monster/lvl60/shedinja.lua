...
local mType = Game.createMonsterType("Shedinja")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Leech Life", power = 7, interval = 10000},
    {name = "Silver Wind", power = 15, interval = 8000},
    {name = "Shadow Ball", power = 7, interval = 10000},
    {name = "Confuse Ray", power = 7, interval = 32000},
    {name = "Bug Buzz", power = 7, interval = 45000},
}
...
pokemon.attacks = {
    ...
    {name = "Leech Life", power = 7, interval = 10000, chance = 100},
    {name = "Silver Wind", power = 15, interval = 8000, chance = 100},
    {name = "Shadow Ball", power = 7, interval = 10000, chance = 100},
    {name = "Confuse Ray", power = 7, interval = 32000, chance = 100},
    {name = "Bug Buzz", power = 7, interval = 45000, chance = 100},
}
