...
local mType = Game.createMonsterType("Pupitar")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Pupitar"
...
pokemon.moves = {
    ...
    {name = "Sandstorm", power = 20, interval = 40000},
}
...
pokemon.attacks = {
    ...
    {name = "Sandstorm", power = 20, interval = 40000, chance = 100},
}
