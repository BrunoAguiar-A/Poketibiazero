...
local mType = Game.createMonsterType("Hitmonlee")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Triple Kick Lee", power = 7, interval = 10000},
    {name = "Mega Kick", power = 12, interval = 20000},
    {name = "Hi Jump Kick", power = 7, interval = 50000},
    {name = "Furious Legs", power = 7, interval = 25000},
}
...
pokemon.attacks = {
    ...
    {name = "Triple Kick Lee", power = 7, interval = 10000, chance = 100},
    {name = "Mega Kick", power = 12, interval = 20000, chance = 100},
    {name = "Hi Jump Kick", power = 7, interval = 50000, chance = 100},
    {name = "Furious Legs", power = 7, interval = 25000, chance = 100},
}
