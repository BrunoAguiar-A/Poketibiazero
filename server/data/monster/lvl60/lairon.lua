...
local mType = Game.createMonsterType("Lairon")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Lairon"
...
pokemon.moves = {
    ...
    {name = "Meteor Mash", power = 12, interval = 30000},
...
pokemon.attacks = {
    ...
    {name = "Meteor Mash", power = 12, interval = 30000, chance = 100},
