...
pokemon.moves = {
    ...
    {name = "Psybeam", power = 1, interval = 5000},
    {name = "Psywave", power = 1, interval = 5000},
    {name = "Confusion", power = 1, interval = 5000},
    {name = "Psychic", power = 1, interval = 20000},
    {name = "Psystrike", power = 1, interval = 30000},
    {name = "Recover", power = 1, interval = 60000},
    {name = "Barrier", power = 1, interval = 30000},
    {name = "Fear", power = 1, interval = 10000},
    {name = "Reflect", power = 1, interval = 10000},
    {name = "Miracle Eye", power = 1, interval = 10000},
}
...
pokemon.attacks = {
    ...
    {name = "Psybeam", power = 1, interval = 5000, chance = 100},
    {name = "Psywave", power = 1, interval = 5000, chance = 100},
    {name = "Confusion", power = 1, interval = 5000, chance = 100},
    {name = "Psychic", power = 1, interval = 20000, chance = 100},
    {name = "Psystrike", power = 1, interval = 30000, chance = 100},
    {name = "Recover", power = 1, interval = 60000, chance = 100},
    {name = "Barrier", power = 1, interval = 30000, chance = 100},
    {name = "Fear", power = 1, interval = 10000, chance = 100},
    {name = "Reflect", power = 1, interval = 10000, chance = 100},
    {name = "Miracle Eye", power = 1, interval = 10000, chance = 100},
}
