...
local mType = Game.createMonsterType("Kingler")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Kingler"
...
pokemon.moves = {
    ...
    {name = "Crabhammer", power = 12, interval = 20000},
    {name = "Metal Claw", power = 7, interval = 30000},
    {name = "Brine", power = 15, interval = 40000},
    {name = "Hyper Beam", power = 15, interval = 50000},
    {name = "Guillotine", power = 7, interval = 30000},
...
pokemon.attacks = {
    ...
    {name = "Crabhammer", power = 12, interval = 20000, chance = 100},
    {name = "Metal Claw", power = 7, interval = 30000, chance = 100},
    {name = "Brine", power = 15, interval = 40000, chance = 100},
    {name = "Hyper Beam", power = 15, interval = 50000, chance = 100},
    {name = "Guillotine", power = 7, interval = 30000, chance = 100},
