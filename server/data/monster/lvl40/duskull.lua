...
local mType = Game.createMonsterType("Duskull")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Confuse Ray", power = 7, interval = 40000},
...
pokemon.attacks = {
    ...
    {name = "Confuse Ray", power = 7, interval = 40000, chance = 100},
