...
local mType = Game.createMonsterType("Ariados")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Ariados"
...
pokemon.moves = {
    ...
    {name = "String Shot", power = 7, interval = 10000},
    {name = "Bug Bite", power = 9, interval = 10000},
    {name = "Poison Sting", power = 7, interval = 8000},
    {name = "Fury Swipes", power = 12, interval = 20000},
    {name = "Poison Job", power = 7, interval = 15000},
    {name = "Pin Missile", power = 7, interval = 20000},
    {name = "Spider Web", power = 7, interval = 25000},
...
pokemon.attacks = {
    ...
    {name = "String Shot", power = 7, interval = 10000, chance = 100},
    {name = "Bug Bite", power = 9, interval = 10000, chance = 100},
    {name = "Poison Sting", power = 7, interval = 8000, chance = 100},
    {name = "Fury Swipes", power = 12, interval = 20000, chance = 100},
    {name = "Poison Job", power = 7, interval = 15000, chance = 100},
    {name = "Pin Missile", power = 7, interval = 20000, chance = 100},
    {name = "Spider Web", power = 7, interval = 25000, chance = 100},
