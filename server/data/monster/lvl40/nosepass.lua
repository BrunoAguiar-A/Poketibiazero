...
local mType = Game.createMonsterType("Nosepass")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Nosepass"
...
pokemon.moves = {
    ...
    {name = "Tackle", power = 7, interval = 20000},
...
pokemon.attacks = {
    ...
    {name = "Tackle", power = 7, interval = 20000, chance = 100},
