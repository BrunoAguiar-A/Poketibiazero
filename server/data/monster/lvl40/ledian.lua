...
pokemon.moves = {
    ...
    {name = "Silver Wind", power = 15, interval = 12000},
    {name = "Struggle Bug", power = 7, interval = 30000},
    {name = "Bug Buzz", power = 7, interval = 25000},
...
pokemon.attacks = {
    ...
    {name = "Silver Wind", power = 15, interval = 12000, chance = 100},
    {name = "Struggle Bug", power = 7, interval = 30000, chance = 100},
    {name = "Bug Buzz", power = 7, interval = 25000, chance = 100},
