...
local mType = Game.createMonsterType("Omanyte")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Omanyte"
...
pokemon.moves = {
    ...
    {name = "Water Ball", power = 8, interval = 15000},
    {name = "Water Gun", power = 8, interval = 20000},
    {name = "Mud Shot", power = 9, interval = 10000},
    {name = "Brine", power = 15, interval = 20000},
...
pokemon.attacks = {
    ...
    {name = "Water Ball", power = 8, interval = 15000, chance = 100},
    {name = "Water Gun", power = 8, interval = 20000, chance = 100},
    {name = "Mud Shot", power = 9, interval = 10000, chance = 100},
    {name = "Brine", power = 15, interval = 20000, chance = 100},
