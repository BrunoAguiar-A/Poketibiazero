...
local mType = Game.createMonsterType("Eevee")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Eevee"
...
pokemon.moves = {
    ...
    {name = "Headbutt", power = 10, interval = 20000},
...
pokemon.attacks = {
    ...
    {name = "Headbutt", power = 10, interval = 20000, chance = 100},
