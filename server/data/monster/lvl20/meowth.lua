...
local mType = Game.createMonsterType("Meowth")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Meowth"
...
pokemon.moves = {
    ...
    {name = "Pay Day", power = 7, interval = 40000},
}
...
pokemon.attacks = {
    ...
    {name = "Pay Day", power = 7, interval = 40000, chance = 100},
}
