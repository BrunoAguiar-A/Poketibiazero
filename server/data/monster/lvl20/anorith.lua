...
local mType = Game.createMonsterType("Anorith")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Hunter Mark", power = 7, interval = 40000},
...
pokemon.attacks = {
    ...
    {name = "Hunter Mark", power = 7, interval = 40000, chance = 100},
