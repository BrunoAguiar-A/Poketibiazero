...
local mType = Game.createMonsterType("Raticate")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Raticate"
pokemon.experience = 2585
pokemon.outfit = {
    lookType = 20
}
...
pokemon.moves = {
    ...
    {name = "Super Fang", power = 7, interval = 20000},
    {name = "Scary Face", power = 0, interval = 35000},
}
...
pokemon.attacks = {
    ...
    {name = "Super Fang", power = 7, interval = 20000, chance = 100},
    {name = "Scary Face", power = 0, interval = 35000, chance = 100},
}
