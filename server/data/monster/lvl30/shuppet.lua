...
local mType = Game.createMonsterType("Shuppet")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Shuppet"
pokemon.experience = 4584
pokemon.outfit = {
    lookType = 1601
}
...
pokemon.moves = {
    ...
    {name = "Night Shade", power = 7, interval = 30000},
    {name = "Invisible", power = 7, interval = 15000},
    {name = "Dark Accurate", power = 7, interval = 25000},
}
...
pokemon.attacks = {
    ...
    {name = "Night Shade", power = 7, interval = 30000, chance = 100},
    {name = "Invisible", power = 7, interval = 15000, chance = 100},
