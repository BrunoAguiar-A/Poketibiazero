...
local mType = Game.createMonsterType("Minun")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Minun"
pokemon.experience = 2811
pokemon.outfit = {
    lookType = 1560
}
...
pokemon.moves = {
    ...
    {name = "Nuzzle", power = 7, interval = 40000},
    {name = "Helping Hand", power = 0, interval = 20000},
    {name = "Fake Tears", power = 7, interval = 45000},
...
pokemon.attacks = {
    ...
    {name = "Nuzzle", power = 7, interval = 40000, chance = 100},
    {name = "Helping Hand", power = 0, interval = 20000, chance = 100},
    {name = "Fake Tears", power = 7, interval = 45000, chance = 100},
