...
local mType = Game.createMonsterType("Numel")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Numel"
pokemon.experience = 6344
pokemon.outfit = {
    lookType = 1570
}
...
pokemon.moves = {
    ...
    {name = "Volcano Shot", power = 7, interval = 5000},
    {name = "Ember", power = 10, interval = 10000},
    {name = "Rock Slide", power = 15, interval = 15000},
    {name = "Flame Burst", power = 15, interval = 25000},
...
pokemon.attacks = {
    ...
    {name = "Volcano Shot", power = 7, interval = 5000, chance = 100},
