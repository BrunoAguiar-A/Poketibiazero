...
local mType = Game.createMonsterType("Spheal")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Spheal"
pokemon.experience = 2145
pokemon.outfit = {
    lookType = 1611
}
...
pokemon.moves = {
    ...
    {name = "Ice Ball", power = 7, interval = 28000},
...
pokemon.attacks = {
    ...
    {name = "Ice Ball", power = 7, interval = 28000, chance = 100},
