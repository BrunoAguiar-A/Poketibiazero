...
local mType = Game.createMonsterType("Poochyena")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Poochyena"
pokemon.experience = 6322
pokemon.outfit = {
    lookType = 1509
}
...
pokemon.moves = {
    ...
    {name = "Shadow Claw", power = 18, interval = 45000},
...
pokemon.attacks = {
    ...
    {name = "Shadow Claw", power = 18, interval = 45000, chance = 100},
