...
local mType = Game.createMonsterType("Meditite")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Meditite"
pokemon.experience = 5211
pokemon.outfit = {
    lookType = 1555
}
...
pokemon.moves = {
    ...
    {name = "Drain Punch", power = 7, interval = 35000},
...
pokemon.attacks = {
    ...
    {name = "Drain Punch", power = 7, interval = 35000, chance = 100},
