...
pokemon.moves = {
    ...
    {name = "U-Turn", power = 15, interval = 5000},
...
pokemon.attacks = {
    ...
    {name = "U-Turn", power = 15, interval = 5000, chance = 100},
