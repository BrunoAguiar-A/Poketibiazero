...
pokemon.moves = {
    ...
    {name = "Horn Burst", power = 5, interval = 20000},
    {name = "Poison Fang", power = 5, interval = 20000},
    {name = "Poison Jab", power = 5, interval = 20000},
    {name = "Poison Tail", power = 5, interval = 40000},
    {name = "Toxic", power = 5, interval = 60000},
    {name = "Venoshock", power = 5, interval = 60000},
...
pokemon.attacks = {
    ...
    {name = "Horn Burst", power = 5, interval = 20000, chance = 100},
    {name = "Poison Fang", power = 5, interval = 20000, chance = 100},
    {name = "Poison Jab", power = 5, interval = 20000, chance = 100},
    {name = "Poison Tail", power = 5, interval = 40000, chance = 100},
    {name = "Toxic", power = 5, interval = 60000, chance = 100},
    {name = "Venoshock", power = 5, interval = 60000, chance = 100},
