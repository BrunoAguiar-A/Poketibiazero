...
local mType = Game.createMonsterType("Slowking")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Slowking"
...
pokemon.moves = {
    ...
    {name = "Water Ball", power = 8, interval = 12000},
    ...
    {name = "Psy Impact", power = 7, interval = 60000},
...
pokemon.attacks = {
    ...
    {name = "Water Ball", power = 8, interval = 12000, chance = 100},
    ...
    {name = "Psy Impact", power = 7, interval = 60000, chance = 100},
