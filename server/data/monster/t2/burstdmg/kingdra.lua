...
local mType = Game.createMonsterType("Kingdra")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Kingdra"
...
pokemon.moves = {
    ...
    {name = "Liquidation", power = 20, interval = 35000},
    {name = "Brine", power = 15, interval = 32000},
    {name = "Water Pulse", power = 9, interval = 25000},
    {name = "Dragon Pulse", power = 7, interval = 50000},
    {name = "Twister", power = 7, interval = 40000},
    {name = "Surf", power = 20, interval = 70000},
    {name = "Endure", power = 7, interval = 70000},
...
pokemon.attacks = {
    ...
    {name = "Liquidation", power = 20, interval = 35000, chance = 100},
    {name = "Brine", power = 15, interval = 32000, chance = 100},
    {name = "Water Pulse", power = 9, interval = 25000, chance = 100},
    {name = "Dragon Pulse", power = 7, interval = 50000, chance = 100},
    {name = "Twister", power = 7, interval = 40000, chance = 100},
    {name = "Surf", power = 20, interval = 70000, chance = 100},
    {name = "Endure", power = 7, interval = 70000, chance = 100},
