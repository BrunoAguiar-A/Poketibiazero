...
local mType = Game.createMonsterType("Aggron")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Metal Burst", power = 7, interval = 30000},
...
pokemon.attacks = {
    ...
    {name = "Metal Burst", power = 7, interval = 30000, chance = 100},
