...
local mType = Game.createMonsterType("Shiny Shuckle")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Shiny Shuckle"
...
pokemon.moves = {
    ...
    {name = "Wrap", power = 5, interval = 35000},
    {name = "Rock Throw", power = 5, interval = 15000},
    {name = "Shell Attack", power = 5, interval = 70000},
    {name = "Struggle Bug", power = 5, interval = 25000},
    {name = "Withdraw", power = 5, interval = 50000},
...
pokemon.attacks = {
    ...
    {name = "Wrap", power = 5, interval = 35000, chance = 100},
    {name = "Rock Throw", power = 5, interval = 15000, chance = 100},
    {name = "Shell Attack", power = 5, interval = 70000, chance = 100},
    {name = "Struggle Bug", power = 5, interval = 25000, chance = 100},
    {name = "Withdraw", power = 5, interval = 50000, chance = 100},
