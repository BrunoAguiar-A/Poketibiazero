...
local mType = Game.createMonsterType("Shiny Grumpig")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Shadowave", power = 5, interval = 15000},
    {name = "Psy Pulse", power = 5, interval = 10000},
    {name = "Psychic", power = 5, interval = 30000},
    {name = "Teeter Dance", power = 5, interval = 45000},
    {name = "Power Gem", power = 5, interval = 20000},
...
pokemon.attacks = {
    ...
    {name = "Shadowave", power = 5, interval = 15000, chance = 100},
    {name = "Psy Pulse", power = 5, interval = 10000, chance = 100},
    {name = "Psychic", power = 5, interval = 30000, chance = 100},
    {name = "Teeter Dance", power = 5, interval = 45000, chance = 100},
    {name = "Power Gem", power = 5, interval = 20000, chance = 100},
