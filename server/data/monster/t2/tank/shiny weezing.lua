...
local mType = Game.createMonsterType("Shiny Weezing")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Shiny Weezing"
...
pokemon.moves = {
    ...
    {name = "Venoshock", power = 5, interval = 40000},
...
pokemon.attacks = {
    ...
    {name = "Venoshock", power = 5, interval = 40000, chance = 100},
