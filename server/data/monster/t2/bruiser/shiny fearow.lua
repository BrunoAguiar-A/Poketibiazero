...
local mType = Game.createMonsterType("Shiny Fearow")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Shiny Fearow"
...
pokemon.moves = {
    ...
    {name = "Sand Attack", power = 5, interval = 12000},
    {name = "Drill Peck", power = 9, interval = 18000},
    {name = "Gust", power = 5, interval = 30000},
...
pokemon.attacks = {
    ...
    {name = "Sand Attack", power = 5, interval = 12000, chance = 100},
    {name = "Drill Peck", power = 9, interval = 18000, chance = 100},
    {name = "Gust", power = 5, interval = 30000, chance = 100},
