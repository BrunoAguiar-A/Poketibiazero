...
local mType = Game.createMonsterType("Electabuzz")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Swift", power = 7, interval = 15000},
    ...
    {name = "Thunder Wrath", power = 7, interval = 30000},
    {name = "Electrify", power = 7, interval = 40000},
    {name = "Flame Charge", power = 12, interval = 50000},
    {name = "Mamaragan", power = 7, interval = 70000},
    {name = "Vital Spirit", power = 7, interval = 60000},
}
...
pokemon.attacks = {
    ...
    {name = "Thunder Wrath", power = 7, interval = 30000, chance = 100},
    {name = "Electrify", power = 7, interval = 40000, chance = 100},
    {name = "Flame Charge", power = 12, interval = 50000, chance = 100},
    {name = "Mamaragan", power = 7, interval = 70000, chance = 100},
    {name = "Vital Spirit", power = 7, interval = 60000, chance = 100},
}
