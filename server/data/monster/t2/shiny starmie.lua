...
local mType = Game.createMonsterType("Shiny Starmie")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Shiny Starmie"
...
pokemon.moves = {
    ...
    {name = "Brine", power = 5, interval = 30000},
    {name = "Rapid spin", power = 5, interval = 40000},
    {name = "Waterfall", power = 5, interval = 40000},
...
pokemon.attacks = {
    ...
    {name = "Brine", power = 5, interval = 30000, chance = 100},
    {name = "Rapid spin", power = 5, interval = 40000, chance = 100},
    {name = "Waterfall", power = 5, interval = 40000, chance = 100},
