...
local mType = Game.createMonsterType("Shiny Togetic")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Dazzling Gleam", power = 5, interval = 18000},
    ...
    {name = "Floral Storm", power = 5, interval = 50000},
...
pokemon.attacks = {
    ...
    {name = "Dazzling Gleam", power = 5, interval = 18000, chance = 100},
    ...
    {name = "Floral Storm", power = 5, interval = 50000, chance = 100},
