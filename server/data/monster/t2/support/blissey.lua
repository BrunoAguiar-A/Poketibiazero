...
local mType = Game.createMonsterType("Blissey")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Great Love", power = 15, interval = 45000},
    {name = "Captivate", power = 7, interval = 38000},
    {name = "Healing Wish", power = 7, interval = 150000},
    {name = "Emergency Call", power = 0, interval = 35000},
    {name = "Protection", power = 0, interval = 40000},
    {name = "Egg Rain", power = 7, interval = 80000},
    {name = "Helping Hand", power = 0, interval = 30000},
    {name = "Attract", power = 0, interval = 45000},
}
...
pokemon.attacks = {
    ...
    {name = "Great Love", power = 15, interval = 45000, chance = 100},
    {name = "Captivate", power = 7, interval = 38000, chance = 100},
    {name = "Healing Wish", power = 7, interval = 150000, chance = 100},
    {name = "Emergency Call", power = 0, interval = 35000, chance = 100},
    {name = "Protection", power = 0, interval = 40000, chance = 100},
    {name = "Egg Rain", power = 7, interval = 80000, chance = 100},
    {name = "Helping Hand", power = 0, interval = 30000, chance = 100},
    {name = "Attract", power = 0, interval = 45000, chance = 100},
}
