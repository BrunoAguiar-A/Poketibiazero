...
local mType = Game.createMonsterType("Shiny Sceptile")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Shiny Sceptile"
...
pokemon.moves = {
    ...
    {name = "Quick Attack", power = 2, interval = 15000},
    {name = "Headbutt", power = 4, interval = 15000},
    {name = "Leaf Blade", power = 3, interval = 20000},
    {name = "Magical Leaf", power = 12, interval = 20000},
    {name = "Leafage", power = 75, interval = 30000},
  --  {name = "Grass Pledge", power = 78, interval = 40000},
    {name = "Frenzy Plant", power = 76, interval = 40000},
    {name = "Leaf Storm", power = 207, interval = 50000},
    {name = "Shadow Rave", power = 25, interval = 50000},
}
