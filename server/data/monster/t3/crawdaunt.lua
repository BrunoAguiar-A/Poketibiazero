...
local mType = Game.createMonsterType("Crawdaunt")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Hone Claws", power = 7, interval = 40000},
    {name = "Bubble Beam", power = 10, interval = 15000},
    {name = "Crunch", power = 9, interval = 15000},
    {name = "Crabhammer", power = 12, interval = 12000},
    {name = "Void Sphere", power = 15, interval = 30000},
    {name = "Night Slash", power = 15, interval = 20000},
...
pokemon.attacks = {
    ...
    {name = "Hone Claws", power = 7, interval = 40000, chance = 100},
    {name = "Bubble Beam", power = 10, interval = 15000, chance = 100},
    {name = "Crunch", power = 9, interval = 15000, chance = 100},
    {name = "Crabhammer", power = 12, interval = 12000, chance = 100},
    {name = "Void Sphere", power = 15, interval = 30000, chance = 100},
    {name = "Night Slash", power = 15, interval = 20000, chance = 100},
