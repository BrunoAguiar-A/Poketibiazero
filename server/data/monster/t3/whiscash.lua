...
local mType = Game.createMonsterType("Whiscash")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Whiscash"
...
pokemon.moves = {
    ...
    {name = "Mud Sludge", power = 7, interval = 15000},
    {name = "Bulldoze", power = 25, interval = 45000},
    {name = "Water Pulse", power = 9, interval = 20000},
    {name = "Earth Power", power = 15, interval = 30000},
    {name = "Fissure", power = 15, interval = 50000},
    {name = "Magnitude", power = 15, interval = 70000},
    {name = "Hydro Pump", power = 20, interval = 80000},
    {name = "Rain Dance", power = 0, interval = 70000},
}
...
pokemon.attacks = {
    ...
    {name = "Mud Sludge", power = 7, interval = 15000, chance = 100},
    {name = "Bulldoze", power = 25, interval = 45000, chance = 100},
    ...
    {name = "Magnitude", power = 15, interval = 70000, chance = 100},
    {name = "Hydro Pump", power = 20, interval = 80000, chance = 100},
    {name = "Rain Dance", power = 0, interval = 70000, chance = 100},
}
