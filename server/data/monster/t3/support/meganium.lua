...
pokemon.attacks = {
    ...
    {name = "Magical Leaf", power = 9, interval = 6000, chance = 30},
    {name = "Petal Bullets", power = 6, interval = 9000, chance = 40},
    {name = "Petal Dance", power = 8, interval = 10000, chance = 25},
    {name = "Sweet Scent", power = 9, interval = 50000, chance = 10},

}

pokemon.defenses = {
    {name = "Ingrain", power = 20, interval = 26000, chance = 20},
    {name = "Protection", power = 0, interval = 22000, chance = 18},
    {name = "Emergency Call", power = 0, interval = 30000, chance = 18},
    {name = "Reflect", power = 0, interval = 24000, chance = 16},
}
