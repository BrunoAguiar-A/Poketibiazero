...
local mType = Game.createMonsterType("Pelipper")
local pokemon = {}
...
pokemon.attacks = {
    ...
    {name = "Feather Dance", power = 12, interval = 20000, chance = 100},
    ...
    {name = "Helping Hand", power = 0, interval = 40000, chance = 100},
    {name = "Rain Dance", power = 0, interval = 50000, chance = 100},
    {name = "Protect", power = 0, interval = 50000, chance = 100},
}
