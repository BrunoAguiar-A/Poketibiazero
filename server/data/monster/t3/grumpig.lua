...
local mType = Game.createMonsterType("Grumpig")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Grumpig"
...
pokemon.moves = {
    ...
    {name = "Shadowave", power = 7, interval = 15000},
    {name = "Psy Pulse", power = 12, interval = 10000},
    {name = "Psychic", power = 12, interval = 30000},
    {name = "Teeter Dance", power = 15, interval = 45000},
    {name = "Power Gem", power = 15, interval = 20000},
...
pokemon.attacks = {
    ...
    {name = "Shadowave", power = 7, interval = 15000, chance = 100},
    {name = "Psy Pulse", power = 12, interval = 10000, chance = 100},
    {name = "Psychic", power = 12, interval = 30000, chance = 100},
    {name = "Teeter Dance", power = 15, interval = 45000, chance = 100},
    {name = "Power Gem", power = 15, interval = 20000, chance = 100},
