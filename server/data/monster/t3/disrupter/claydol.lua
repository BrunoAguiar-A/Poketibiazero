...
local mType = Game.createMonsterType("Claydol")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Mud Sport", power = 7, interval = 32000},
    {name = "Extrasensory", power = 15, interval = 25000},
    {name = "Psybeam", power = 7, interval = 10000},
    {name = "Psychic", power = 12, interval = 30000},
    {name = "Earth Power", power = 15, interval = 35000},
    {name = "Earthquake", power = 7, interval = 60000},
    {name = "Sandstorm", power = 20, interval = 60000},
    {name = "Heal Block", power = 0, interval = 80000},
    {name = "Guard Split", power = 0, interval = 80000},
    {name = "Protect", power = 0, interval = 60000},
}
...
pokemon.attacks = {
    ...
    {name = "Mud Sport", power = 7, interval = 32000, chance = 100},
    {name = "Extrasensory", power = 15, interval = 25000, chance = 100},
    {name = "Psybeam", power = 7, interval = 10000, chance = 100},
    {name = "Psychic", power = 12, interval = 30000, chance = 100},
    {name = "Earth Power", power = 15, interval = 35000, chance = 100},
    {name = "Earthquake", power = 7, interval = 60000, chance = 100},
    {name = "Sandstorm", power = 20, interval = 60000, chance = 100},
    {name = "Heal Block", power = 0, interval = 80000, chance = 100},
    {name = "Guard Split", power = 0, interval = 80000, chance = 100},
    {name = "Protect", power = 0, interval = 60000, chance = 100},
}
