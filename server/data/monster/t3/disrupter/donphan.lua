...
local mType = Game.createMonsterType("Donphan")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Mud-Slap", power = 7, interval = 30000},
    {name = "Fire Fang", power = 7, interval = 18000},
    {name = "Horn Attack", power = 12, interval = 15000},
    {name = "Rollout", power = 12, interval = 25000},
    {name = "Cannon Ball", power = 15, interval = 40000},
    {name = "Bulldoze", power = 25, interval = 40000},
    {name = "Scary Face", power = 0, interval = 40000},
    {name = "Earthquake", power = 7, interval = 70000},
...
pokemon.attacks = {
    ...
    {name = "Mud-Slap", power = 7, interval = 30000, chance = 100},
    {name = "Fire Fang", power = 7, interval = 18000, chance = 100},
    {name = "Horn Attack", power = 12, interval = 15000, chance = 100},
    {name = "Rollout", power = 12, interval = 25000, chance = 100},
    {name = "Cannon Ball", power = 15, interval = 40000, chance = 100},
    {name = "Bulldoze", power = 25, interval = 40000, chance = 100},
    {name = "Scary Face", power = 0, interval = 40000, chance = 100},
    {name = "Earthquake", power = 7, interval = 70000, chance = 100},
