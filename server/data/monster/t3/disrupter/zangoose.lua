...
local mType = Game.createMonsterType("Zangoose")
local pokemon = {}
...
pokemon.attacks = {
    ...
    {name = "Mud-Slap", power = 7, interval = 32000, chance = 100},
    {name = "Dig", power = 5, interval = 40000, chance = 100},
    {name = "Crush Claw", power = 12, interval = 45000, chance = 100},
    {name = "Pursuit", power = 15, interval = 22000, chance = 100},
    ...
    {name = "Taunt", power = 18, interval = 60000, chance = 100},
}
