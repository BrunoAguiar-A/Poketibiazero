...
local mType = Game.createMonsterType("Ampharos")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Electric Storm", power = 15, interval = 60000},
...
pokemon.attacks = {
    ...
    {name = "Electric Storm", power = 25, interval = 60000, chance = 100},
