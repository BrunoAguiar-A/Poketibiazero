...
local mType = Game.createMonsterType("Omastar")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Omastar"
pokemon.experience = 4583
pokemon.outfit = {
    lookType = 139
}

pokemon.health = 16596
pokemon.maxHealth = pokemon.health
pokemon.race = "rock"
pokemon.race2 = "water"
pokemon.corpse = 27000
pokemon.speed = 180
...
pokemon.moves = {
    ...
    {name = "Rollout", power = 12, interval = 35000},
    {name = "Ancient Power", power = 15, interval = 40000},
    {name = "Falling Rocks", power = 20, interval = 60000},
...
pokemon.attacks = {
    ...
    {name = "Rollout", power = 12, interval = 35000, chance = 100},
...
pokemon.defenses = {
    {name = "Harden", power = 0, interval = 24000, chance = 18},
}
