...
pokemon.moves = {
    ...
    {name = "Sand Tomb", power = 15, interval = 40000},
    {name = "Horn Burst", power = 15, interval = 15000},
    {name = "Ground Collapse", power = 30, interval = 40000},
    {name = "Bulldoze", power = 20, interval = 40000},
    {name = "Earthquake", power = 15, interval = 50000},
    {name = "Fissure", power = 25, interval = 50000},
...
pokemon.attacks = {
    ...
    {name = "Sand Tomb", power = 15, interval = 40000, chance = 100},
    {name = "Horn Burst", power = 15, interval = 15000, chance = 100},
    {name = "Ground Collapse", power = 7, interval = 40000, chance = 100},
    {name = "Bulldoze", power = 25, interval = 40000, chance = 100},
    {name = "Earthquake", power = 7, interval = 50000, chance = 100},
    {name = "Fissure", power = 25, interval = 50000, chance = 100},
