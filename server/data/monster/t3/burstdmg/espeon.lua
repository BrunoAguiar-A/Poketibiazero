...
local mType = Game.createMonsterType("Espeon")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Espeon"
...
pokemon.moves = {
    ...
    {name = "Psy Pulse", power = 12, interval = 12000},
    {name = "Confusion", power = 10, interval = 30000},
    {name = "Psychic", power = 15, interval = 25000},
    {name = "Psyshock", power = 25, interval = 30000},
    {name = "Trick Room", power = 30, interval = 60000},
...
pokemon.attacks = {
    ...
    {name = "Psy Pulse", power = 12, interval = 12000, chance = 100},
    {name = "Confusion", power = 10, interval = 30000, chance = 100},
    {name = "Psychic", power = 15, interval = 25000, chance = 100},
    {name = "Psyshock", power = 25, interval = 30000, chance = 100},
    {name = "Trick Room", power = 30, interval = 60000, chance = 100},
