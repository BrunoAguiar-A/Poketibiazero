...
local mType = Game.createMonsterType("Rattata")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Rattata"
pokemon.experience = 22
pokemon.outfit = {
    lookType = 19
}
...
pokemon.evolutions = {
    {
        ...
        chance = 100,
        stones = {
            {stoneId = 26729, stoneCount = 2} --water = 26732, fire = 26728, leaf = 26731, cocoon = 26724, heart = 26729
        }
    }
}
...
pokemon.moves = {
    ...
    {name = "Scratch", power = 7, interval = 15000},
    {name = "Super Fang", power = 7, interval = 45000},
}
...
pokemon.attacks = {
    ...
    {name = "Scratch", power = 7, interval = 15000, chance = 100},
    {name = "Super Fang", power = 7, interval = 45000, chance = 100},
}
