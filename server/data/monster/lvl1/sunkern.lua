...
local mType = Game.createMonsterType("Sunkern")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Sunkern"
pokemon.experience = 32
pokemon.outfit = {
    lookType = 842
}
...
pokemon.moves = {
    ...
    {name = "Leech Seed", power = 15, interval = 35000},
...
pokemon.attacks = {
    ...
    {name = "Leech Seed", power = 15, interval = 35000, chance = 100},
