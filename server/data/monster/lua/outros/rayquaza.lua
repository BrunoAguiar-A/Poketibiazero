...
pokemon.moves = {
    ...
    {name = "Extreme Speed", power = 7, interval = 25000},
    {name = "Hyper Voice", power = 15, interval = 40000},
    {name = "Ancient Power", power = 20, interval = 30000},
    {name = "Air Slash", power = 12, interval = 28000},
    {name = "Dragon Ascent", power = 7, interval = 40000},
    {name = "Dragon Pulse", power = 7, interval = 35000},
    {name = "Hyper Beam", power = 15, interval = 45000},
    {name = "Outrage", power = 7, interval = 60000},
    {name = "Solar Beam", power = 15, interval = 50000},
}
...
pokemon.attacks = {
    ...
    {name = "Extreme Speed", power = 7, interval = 25000, chance = 100},
    {name = "Hyper Voice", power = 15, interval = 40000, chance = 100},
    {name = "Ancient Power", power = 20, interval = 30000, chance = 100},
    {name = "Air Slash", power = 12, interval = 28000, chance = 100},
    {name = "Dragon Ascent", power = 7, interval = 40000, chance = 100},
    ...
    {name = "Solar Beam", power = 15, interval = 50000, chance = 100},
}
