...
local mType = Game.createMonsterType("Shellder")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Clamp", power = 7, interval = 15000},
...
pokemon.attacks = {
    ...
    {name = "Clamp", power = 7, interval = 15000, chance = 100},
