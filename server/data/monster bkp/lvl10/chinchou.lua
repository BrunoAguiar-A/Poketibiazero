...
local mType = Game.createMonsterType("Chinchou")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Chinchou"
...
pokemon.moves = {
    ...
    {name = "Spark", power = 12, interval = 12000},
...
pokemon.attacks = {
    ...
    {name = "Spark", power = 12, interval = 12000, chance = 100},
