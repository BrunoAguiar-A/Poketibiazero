...
local mType = Game.createMonsterType("Seedot")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Feint Attack", power = 15, interval = 28000},
}
...
pokemon.attacks = {
    ...
    {name = "Feint Attack", power = 15, interval = 28000, chance = 100},
}
