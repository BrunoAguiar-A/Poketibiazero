...
local mType = Game.createMonsterType("Magikarp")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Magikarp"
pokemon.experience = 210
pokemon.outfit = {
    lookType = 129
}
...
pokemon.moves = {
    ...
    {name = "Splash", power = 7, interval = 15000},
}
...
pokemon.attacks = {
    ...
    {name = "Splash", power = 7, interval = 15000, chance = 100},
}
