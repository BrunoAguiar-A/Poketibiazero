...
local mType = Game.createMonsterType("Igglybuff")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Sing", power = 0, interval = 80000},
    {name = "Hyper Voice", power = 15, interval = 50000},
...
pokemon.attacks = {
    ...
    {name = "Sing", power = 0, interval = 80000, chance = 100},
    {name = "Hyper Voice", power = 15, interval = 50000, chance = 100},
