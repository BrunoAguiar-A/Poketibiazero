...
local mType = Game.createMonsterType("Seel")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Seel"
...
pokemon.moves = {
    ...
    {name = "Aqua Tail", power = 8, interval = 12000},
...
pokemon.attacks = {
    ...
    {name = "Aqua Tail", power = 8, interval = 12000, chance = 100},
