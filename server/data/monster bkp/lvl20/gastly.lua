...
local mType = Game.createMonsterType("Gastly")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Gastly"
...
pokemon.evolutions = {
    ...
    } --enigma = 26727, earth = 26742, punch = 26732,crystal 26725, ancient = 26749, feather = 26743 ice = 26730, ice =26726
}
