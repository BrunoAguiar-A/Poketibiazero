...
local mType = Game.createMonsterType("Phanpy")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Tackle", power = 7, interval = 5000},
    {name = "Take Down", power = 7, interval = 15000},
    {name = "Horn Attack", power = 12, interval = 10000},
    {name = "Rollout", power = 12, interval = 30000},
    {name = "Defense Curl", power = 0, interval = 45000},
}
...
pokemon.attacks = {
    ...
    {name = "Tackle", power = 7, interval = 5000, chance = 100},
    {name = "Take Down", power = 7, interval = 15000, chance = 100},
    {name = "Horn Attack", power = 12, interval = 10000, chance = 100},
    {name = "Rollout", power = 12, interval = 30000, chance = 100},
    {name = "Defense Curl", power = 0, interval = 45000, chance = 100},
}
