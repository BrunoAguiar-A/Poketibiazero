...
local mType = Game.createMonsterType("Vulpix")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Vulpix"
...
pokemon.moves = {
    ...
    {name = "Flame Circle", power = 12, interval = 10000},
...
pokemon.attacks = {
    ...
    {name = "Flame Circle", power = 12, interval = 10000, chance = 100},
