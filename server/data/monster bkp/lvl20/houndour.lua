...
pokemon.moves = {
    ...
    {name = "Shadowave", power = 7, interval = 18000},
    {name = "Flamethrower", power = 10, interval = 20000},
    {name = "Incinerate", power = 12, interval = 30000},
}
...
pokemon.attacks = {
    ...
    {name = "Shadowave", power = 7, interval = 18000, chance = 100},
    {name = "Flamethrower", power = 10, interval = 20000, chance = 100},
    {name = "Incinerate", power = 12, interval = 30000, chance = 100},
}
