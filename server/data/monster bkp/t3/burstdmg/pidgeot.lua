...
local mType = Game.createMonsterType("Pidgeot")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Pidgeot"
pokemon.experience = 7500
pokemon.outfit = {
    lookType = 18
}
...
pokemon.moves = {
    ...
    {name = "Feather Dance", power = 15, interval = 10000},
    {name = "Whirlwind", power = 12, interval = 50000},
    {name = "Wing Attack", power = 15, interval = 25000},
    {name = "Tornado", power = 18, interval = 60000},
    {name = "Hurricane", power = 20, interval = 50000},
    {name = "Air Slash", power = 30, interval = 50000},
    {name = "Agility", power = 0, interval = 50000},
}
...
pokemon.attacks = {
    ...
    {name = "Whirlwind", power = 7, interval = 50000, chance = 100},
    {name = "Wing Attack", power = 15, interval = 25000, chance = 100},
    {name = "Tornado", power = 18, interval = 60000, chance = 100},
    {name = "Hurricane", power = 20, interval = 50000, chance = 100},
    {name = "Air Slash", power = 30, interval = 50000, chance = 100},
    {name = "Agility", power = 0, interval = 50000, chance = 100},
}
