...
local mType = Game.createMonsterType("Shiny Koffing")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Poison Gas", power = 5, interval = 30000},
...
pokemon.attacks = {
    ...
    {name = "Poison Gas", power = 5, interval = 30000, chance = 100},
