...
local mType = Game.createMonsterType("Electrode")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Electrode"
...
pokemon.moves = {
    ...
    {name = "Rollout", power = 12, interval = 45000},
    {name = "Charge Beam", power = 7, interval = 30000},
    {name = "Electric Storm", power = 25, interval = 80000},
    {name = "Selfdestruction", power = 7, interval = 80000},
}
...
pokemon.attacks = {
    ...
    {name = "Rollout", power = 12, interval = 45000, chance = 100},
    {name = "Charge Beam", power = 7, interval = 30000, chance = 100},
    {name = "Electric Storm", power = 25, interval = 80000, chance = 100},
    {name = "Selfdestruction", power = 7, interval = 80000, chance = 100},
}
