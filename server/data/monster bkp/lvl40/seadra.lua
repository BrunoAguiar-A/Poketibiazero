...
local mType = Game.createMonsterType("Seadra")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Seadra"
...
pokemon.moves = {
    ...
    {name = "Smokescreen", power = 7, interval = 35000},
    ...
    {name = "Hydro Cannon", power = 15, interval = 45000},
}
...
pokemon.attacks = {
    ...
    {name = "Smokescreen", power = 7, interval = 35000, chance = 100},
    ...
    {name = "Hydro Cannon", power = 15, interval = 45000, chance = 100},
}
