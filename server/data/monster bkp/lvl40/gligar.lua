...
local mType = Game.createMonsterType("Gligar")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Guillotine", power = 7, interval = 40000},
...
pokemon.attacks = {
    ...
    {name = "Guillotine", power = 7, interval = 40000, chance = 100},
