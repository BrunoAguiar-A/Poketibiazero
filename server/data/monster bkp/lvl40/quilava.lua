...
local mType = Game.createMonsterType("Quilava")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Quilava"
...
pokemon.moves = {
    ...
    {name = "Quick Attack", power = 3, interval = 15000},
    {name = "Swift", power = 4, interval = 15000},
    {name = "Ember", power = 6, interval = 10000},
    {name = "Flamethrower", power = 9, interval = 20000},
    {name = "Flame Circle", power = 8, interval = 20000},
    {name = "Smokescreen", power = 2, interval = 20000},
    {name = "Eruption", power = 9, interval = 45000},
    {name = "Lava Plume", power = 12, interval = 45000},
...
pokemon.attacks = {
    ...
    {name = "Swift", power = 7, interval = 15000, chance = 100},
    ...
    {name = "Smokescreen", power = 7, interval = 20000, chance = 100},
    {name = "Eruption", power = 15, interval = 45000, chance = 100},
    {name = "Lava Plume", power = 15, interval = 45000, chance = 100},
