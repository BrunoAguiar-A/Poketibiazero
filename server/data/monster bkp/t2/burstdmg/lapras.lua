...
pokemon.moves = {
    ...
    {name = "Powder Snow", power = 15, interval = 30000},
    {name = "Frost Power", power = 25, interval = 40000},
    {name = "Ice Storm", power = 7, interval = 60000},
    {name = "Blizzard", power = 25, interval = 60000},
    {name = "Sing", power = 0, interval = 60000},
}
...
pokemon.attacks = {
    ...
    {name = "Powder Snow", power = 15, interval = 30000, chance = 100},
    {name = "Frost Power", power = 25, interval = 40000, chance = 100},
    {name = "Ice Storm", power = 7, interval = 60000, chance = 100},
    {name = "Blizzard", power = 25, interval = 60000, chance = 100},
    {name = "Sing", power = 0, interval = 60000, chance = 100},
}
