...
local mType = Game.createMonsterType("Infernape")
local pokemon = {}
pokemon.eventFile = false
pokemon.eventFile = "default" 
pokemon.description = "a Infernape"
...
pokemon.moves = {
	...
	{name = "Acrobatic Dodge", power = 20, interval = 25000},
	{name = "Flaming Dash", power = 20, interval = 25000},
