...
local mType = Game.createMonsterType("Nuzleaf")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Nuzleaf"
pokemon.experience = 5322
pokemon.outfit = {
    lookType = 1522
}
...
pokemon.moves = {
    ...
    {name = "Assurance", power = 20, interval = 25000},
...
pokemon.attacks = {
    ...
    {name = "Assurance", power = 20, interval = 25000, chance = 100},
