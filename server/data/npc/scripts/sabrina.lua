local pokemons = 
{
	[1] = { name = "Sabrina's Espeon", level = 100 },
	[2] = { name = "Sabrina's Mr. Mime", level = 100 },
	[3] = { name = "Sabrina's Kadabra", level = 100 },
	[4] = { name = "Sabrina's Jynx", level = 100 },
	[5] = { name = "Sabrina's Wobbuffet", level = 100 },
	[6] = { name = "Sabrina's Alakazam", level = 100 }
}
