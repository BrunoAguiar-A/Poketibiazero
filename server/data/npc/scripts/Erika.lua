local pokemons = 
{
	[1] = { name = "Erika's Tangela", level = 100 },
	[2] = { name = "Erika's Parasect", level = 100 },
	[3] = { name = "Erika's Victreebel", level = 100 },
	[4] = { name = "Erika's Exeggutor", level = 100 },
	[5] = { name = "Erika's Vileplume", level = 100 }
}
