...
class LuaScriptInterface
{
	...
	private:
		...
		static int luaGetCombatName(lua_State* L);
		...
		static int luaGetMonstersName(lua_State* L);

		static int luaIsMoveable(lua_State* L);
		static int luaIsValidUID(lua_State* L);
				
		static int luaAddDuelistType(lua_State* L);

		static int luaAddMarketItem(lua_State* L);
		static int luaRemoveMarketItem(lua_State* L);
		static int luaGetMarketItems(lua_State* L);
		static int luaGetPlayerMarketItems(lua_State* L);
		static int luaGetMarketItemById(lua_State* L);
		static int luaPlayerAddMarketItem(lua_State* L);
		static int luaUpdateMarketItemAmount(lua_State* L);
		static int luaSetMarketItemExpired(lua_State* L);

		static int luaGetMarketItemsPage(lua_State* L);
		static int luaGetPlayerMarketItemsPage(lua_State* L);

		static int luaGetMarketItemsSize(lua_State* L);
		static int luaGetPlayerMarketItemsSize(lua_State* L);

		static int luaGetMarketItemsByNameAndCategory(lua_State* L);
		static int luaGetMarketItemsByNameAndCategorySize(lua_State* L);
		...
		static int luaPlayerGetUsingPokeball(lua_State* L);
		static int luaPlayerSetUsingPokeball(lua_State* L);

		static int luaPlayerInsertBall(lua_State* L);
		static int luaPlayerGetPokeballsCached(lua_State* L);
		static int luaPlayerClearPokeballs(lua_State* L);
		

		static int luaPlayerSetLastTimePokeballUse(lua_State* L);
		static int luaPlayerGetLastTimePokeballUse(lua_State* L);
		...
		static int luaGameGetMonstersFromPos(lua_State* L);
		...
		static int luaGameCreateDuelist(lua_State* L);
		...
		static int luaGameGetZoneByID(lua_State* L);
		...
		static int luaGameAddGuild(lua_State* L);
		static int luaGameRemoveGuild(lua_State* L);
		static int luaGameGetGuilds(lua_State* L);
		static int luaGameGetGuild(lua_State* L);
		...
		static int luaPositionShakeScreen(lua_State* L);

		// zone
		static int luaGetZone(lua_State* L);
		static int luaGetZoneName(lua_State* L);
		static int luaGetZoneId(lua_State* L);
		static int luaGetZoneRange(lua_State* L);
		static int luaCleanZone(lua_State* L);
		...
		static int luaTileUpdate(lua_State* L);
		static int luaTileGetZoneId(lua_State* L);
		static int luaTileGetZone(lua_State* L);
		static int luaTileLoadZoneId(lua_State* L);
		...
		static int luaItemSetIntAttribute(lua_State* L);
		...
		static int luaContainerIsHoldingUniqueItem(lua_State* L);

		static int luaContainerGetPokeballsCached(lua_State* L);
		...
		static int luaCreatureAddCustomIcon(lua_State* L);
		static int luaCreatureRemoveCustomIcon(lua_State* L);
		static int luaCreatureCleanCustomIcons(lua_State* L);
		...
		static int luaCreatureUpdateCreatureType(lua_State* L);
		...
		static int luaCreatureSetOldMaxHealth(lua_State* L);
		...
		static int luaCreatureSetNameColor(lua_State* L);
		...
		static int luaCreatureSetBossStatus(lua_State* L);
		...
		static int luaCreatureCancelWalk(lua_State* L);
		...
		static int luaCreatureSendJump(lua_State* L);
		static int luaCreatureSendFirstTitle(lua_State* L);

		static int luaCreatureSetNickname(lua_State* L);

		static int luaCreatureSetSpeed(lua_State* L);
		
		/*static int luaCreatureHasIcon(lua_State* L);
		static int luaCreatureAddIcon(lua_State* L);
		...
		*/
		...
		static int luaPlayerGetGuildPermissions(lua_State* L);
		static int luaPlayerHasGuildPermission(lua_State* L);

		static int luaPlayerAddInboxMessage(lua_State* L);
		static int luaPlayerFinishInboxMessage(lua_State* L);
		static int luaPlayerGetGuildInbox(lua_State* L);
		static int luaPlayerGetGuildInboxById(lua_State* L);
		...
		static int luaSetStringStorageValue(lua_State* L);
		static int luaGetStringStorageValue(lua_State* L);
		static int luaCreatureGetZoneId(lua_State* L);
		static int luaCreatureGetCurrentZone(lua_State* L);

		static int luaCreatureInsertAttachedEffect(lua_State* L);
		static int luaCreatureRemoveAttachedEffect(lua_State* L);
		static int luaCreatureCleanAttachedEffects(lua_State* L);
		...
		static int luaPlayerSetFly(lua_State* L);
		static int luaPlayerRefreshWalkCache(lua_State* L);

		static int luaPlayerSetMarketSellItem(lua_State* L);
		static int luaPlayerCanSellMarketItem(lua_State* L);

		static int luaPlayerSetElementalBuff(lua_State* L);
		static int luaPlayerGetElementalBuff(lua_State* L);
		...
		static int luaPlayerSendClosePrivate(lua_State* L);
		...
		static int luaPlayerGetItemByPos(lua_State* L);
		...
		static int luaPlayerAddBrokes(lua_State* L);
		static int luaPlayerResetBrokes(lua_State* L);
		static int luaPlayerGetBrokes(lua_State* L);
		static int luaPlayerGetAllBrokes(lua_State* L);
		static int luaPlayerGetUsedPokeballs(lua_State* L);

		static int luaPlayerAddCatchPoints(lua_State* L);
		static int luaPlayerResetCatchPoints(lua_State* L);
		static int luaPlayerGetCatchPoints(lua_State* L);

		static int luaPlayerAddGuardian(lua_State* L);
		static int luaPlayerRemoveGuardian(lua_State* L);
		static int luaPlayerGetGuardians(lua_State* L);
		
		static int luaPlayerGetGuildEmblem(lua_State* L);

		static int luaPlayerApplyGuildBuffs(lua_State* L);
		static int luaPlayerRemoveGuildBuffs(lua_State* L);
		static int luaPlayerUpdateRegeneration(lua_State* L);
		static int luaPlayerAddGuildContribution(lua_State* L);
		static int luaPlayerGetGuildContribution(lua_State* L);

		static int luaPlayerSetSpectating(lua_State* L);
    	static int luaPlayerAddSpectator(lua_State* L);
    	static int luaPlayerRemoveSpectator(lua_State* L);
    	static int luaPlayerGetSpectating(lua_State* L);
		...
		static int luaMonsterIsGuardian(lua_State* L);
		...
		static int luaMonsterGetBoost(lua_State* L);

		static int luaMonsterSetOrderPosition(lua_State* L);
		static int luaMonsterGetOrderPosition(lua_State* L);

		static int luaMonsterSetPokeStopped(lua_State* L);
		static int luaMonsterIsPokeStopped(lua_State* L);
		
		static int luaMonsterIsGhost(lua_State* L);

		// Duelist
		static int luaDuelistCreate(lua_State* L);
		static int luaDuelistIsDuelist(lua_State* L);
		static int luaDuelistSetContract(lua_State* L);
		static int luaDuelistSetContractId(lua_State* L);
		static int luaDuelistGetContractId(lua_State* L);
		...
		static int luaNpcIsHolder(lua_State* L);

		// Guild
		static int luaGuildCreate(lua_State* L);

		static int luaGuildSave(lua_State* L);
		...
		static int luaGuildRemoveOnlineMember(lua_State* L);
		static int luaGuildSetMemberRank(lua_State* L);
		static int luaGuildGetMemberRank(lua_State* L);

		static int luaGuildAddRank(lua_State* L);
		static int luaGuildEditRank(lua_State* L);
		static int luaGuildRemoveRank(lua_State* L);
		static int luaGuildGetDefaultRank(lua_State* L);
		static int luaGuildGetRanks(lua_State* L);
		static int luaGuildGetRankById(lua_State* L);
		static int luaGuildGetRankByName(lua_State* L);
		...
		static int luaGuildGetGold(lua_State* L);
		static int luaGuildSetGold(lua_State* L);
		static int luaGuildAddGold(lua_State* L);
		static int luaGuildRemoveGold(lua_State* L);

		static int luaGuildGetRequiredLevel(lua_State* L);
		static int luaGuildSetRequiredLevel(lua_State* L);

		static int luaGuildGetEmblem(lua_State* L);
		static int luaGuildSetEmblem(lua_State* L);

		static int luaGuildGetWarsWon(lua_State* L);
		static int luaGuildSetWarsWon(lua_State* L);
		static int luaGuildAddWarsWon(lua_State* L);

		static int luaGuildGetWarsLost(lua_State* L);
		static int luaGuildSetWarsLost(lua_State* L);
		static int luaGuildAddWarsLost(lua_State* L);

		static int luaGuildGetLanguage(lua_State* L);
		static int luaGuildSetLanguage(lua_State* L);

		static int luaGuildGetJoinStatus(lua_State* L);
		static int luaGuildSetJoinStatus(lua_State* L);

		static int luaGuildGetBuffs(lua_State* L);
		static int luaGuildSetBuff(lua_State* L);
		static int luaGuildHasBuff(lua_State* L);

		static int luaGuildGetPacifism(lua_State* L);
		static int luaGuildSetPacifism(lua_State* L);
		static int luaGuildIsPacifist(lua_State* L);

		static int luaGuildGetPacifismStatus(lua_State* L);
		static int luaGuildSetPacifismStatus(lua_State* L);

		static int luaGuildGetCombinedLevels(lua_State* L);

		static int luaGuildSetLeaderName(lua_State* L);
		static int luaGuildGetLeaderName(lua_State* L);

		static int luaGuildGetMemberCount(lua_State* L);

		static int luaGuildAddWar(lua_State* L);
		static int luaGuildRemoveWar(lua_State* L);
		static int luaGuildIsInWar(lua_State* L);
		static int luaGuildIsInAnyWar(lua_State* L);
		static int luaGuildGetWarEndDate(lua_State* L);
		static int luaGuildGetWar(lua_State* L);
		static int luaGuildGetWars(lua_State* L);
		static int luaGuildAddWarKill(lua_State* L);
		static int luaGuildSetWarStatus(lua_State* L);

		static int luaGuildSetLastBuffSave(lua_State* L);
		static int luaGuildGetLastBuffSave(lua_State* L);
		...
		static int luaItemTypeIsHolder(lua_State* L);
		...
		static int luaCombatGetConditionsSize(lua_State* L);
		static int luaCombatClearConditions(lua_State* L);
		static int luaCombatSetParameter(lua_State* L);
		static int luaCombatSetStringParameter(lua_State* L);
		...
		static int luaConditionSaveCondition(lua_State* L);
		...
		static int luaConditionSetBonus(lua_State* L);
		static int luaConditionGetBonus(lua_State* L);
		...
		static int luaMonsterTypeCanBlink(lua_State* L);
		
		static int luaMonsterTypeCanDig(lua_State* L);
		static int luaMonsterTypeCanSmash(lua_State* L);
		static int luaMonsterTypeCanCut(lua_State* L);
		static int luaMonsterTypeCanLight(lua_State* L);
		static int luaMonsterTypeCanLevitate(lua_State* L);
		static int luaMonsterTypeCanControlMind(lua_State* L);
		static int luaMonsterTypeFuncao(lua_State* L);
		...
		static int luaMonsterTypeGetPhysicalDamage(lua_State* L);
		static int luaMonsterTypeGetSpecialDamage(lua_State* L);
		static int luaMonsterTypeGetSpecialDefense(lua_State* L);
		static int luaMonsterTypeGetPhysicalDefense(lua_State* L);
		static int luaMonsterTypeGetMinimumLevel(lua_State* L);
		static int luaMonsterTypeWildHealth(lua_State* L);
		static int luaMonsterTypeWildMaxHealth(lua_State* L);
		static int luaMonsterTypeWildBaseSpeed(lua_State* L);
		static int luaMonsterTypeGetPokemonRank(lua_State* L);
		...
		static int luaMonsterTypeAddMove(lua_State* L);
		...
		static int luaMonsterTypeGetMoveList(lua_State* L);
		...
		static int luaMonsterTypeAddEvolution(lua_State* L);
		static int luaMonsterTypeGetEvolutionList(lua_State* L);


		static int luaMonsterTypeRace2(lua_State* L);
		static int luaMonsterTypeGetMinLevel(lua_State* L);
		...
		static int luaMonsterSpellSetPower(lua_State* L);
		static int luaMonsterSpellSetLevel(lua_State* L);
		static int luaMonsterSpellSetPassive(lua_State* L);
