...
function displayMessage(mode, text)
  ...
  -- SE FOR MESSAGE_LOOT E TIVER COR CUSTOMIZADA, USAR ELA
  if mode == MessageModes.Loot and _G.currentBroadcastColor then
    msgtype = table.copy(msgtype) -- Copiar para não alterar o original
    msgtype.color = _G.currentBroadcastColor
  end
