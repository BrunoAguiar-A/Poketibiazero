...
-- Removendo bloqueio para itens virtuais permitir tooltips em containers
-- if self:isVirtual() and not self.isTradeItem and not self.advancedTooltip then return end
  ...
  -- Removido bloqueio de items não arrastáveis para permitir tooltip
  -- if not self:isDraggable() then return end

  -- Só processa drag se realmente estiver arrastando algo
